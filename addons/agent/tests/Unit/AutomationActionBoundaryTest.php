...
final class AutomationActionBoundaryTest extends TestCase
{
    ...
    {
        $base = dirname(__DIR__, 4).'/addons/agent/src'.DIRECTORY_SEPARATOR.'Automation'.DIRECTORY_SEPARATOR.'Actions';
    ...
    public function test_group2_wired_callers_and_bridges_avoid_wordpress_outbound(): void
    {
        $paths = [
            ...
            dirname(__DIR__, 4).'/addons/ai-prompt/src/Services/PromptTestPublishService.php',
            dirname(__DIR__, 4).'/addons/agent/src/Automation/Migration/ProjectArticleCreateCallerBridge.php',
            dirname(__DIR__, 4).'/addons/agent/src/Automation/Migration/ProjectArticleContentCallerBridge.php',
            dirname(__DIR__, 4).'/addons/agent/src/Automation/Migration/ProjectArticleSeoMetaCallerBridge.php',
        ];
