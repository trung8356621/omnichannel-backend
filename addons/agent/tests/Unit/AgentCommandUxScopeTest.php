...
final class AgentCommandUxScopeTest extends TestCase
{
    ...
    {
        $path = dirname(__DIR__, 4).'/addons/agent/resources/js/agent/command-catalog.js';
    ...
    public function test_frontend_and_php_catalog_command_names_match(): void
    {
        ...
        $js = (string) file_get_contents(dirname(__DIR__, 4).'/addons/agent/resources/js/agent/command-catalog.js');
