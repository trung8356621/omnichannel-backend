...
final class WordpressCutoverCouplingTest extends TestCase
{
    ...
    {
        self::assertFileExists(dirname(__DIR__, 4).'/addons/wordpress/src/Services/WordPressManualSyncService.php');
        self::assertFileExists(dirname(__DIR__, 4).'/addons/wordpress/src/Services/ManualSyncContext.php');
        self::assertFileExists(dirname(__DIR__, 4).'/addons/wordpress/src/Jobs/ManualWordPressSyncJob.php');
        self::assertFileExists(dirname(__DIR__, 4).'/addons/agent/src/Automation/BusinessHook/Actions/SyncArticleToWordPressHookAction.php');
        self::assertFileExists(dirname(__DIR__, 4).'/addons/wordpress/src/Console/AutomationAuditWordpressCouplingCommand.php');

        $controller = (string) file_get_contents(dirname(__DIR__, 4).'/addons/content/src/Http/Controllers/ArticleEditorSyncController.php');
    ...
    public function test_execution_service_cancels_when_rule_disabled(): void
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/agent/src/Automation/BusinessHook/Services/AutomationExecutionService.php',
        );
    ...
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/agent/src/Automation/BusinessHook/Services/AutomationRuleService.php',
        );
        self::assertStringContainsString('cancellation_requested_at', $source);
    ...
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/agent/src/Automation/Modules/WordPress/WordPressAutomationModuleProvider.php',
        );
