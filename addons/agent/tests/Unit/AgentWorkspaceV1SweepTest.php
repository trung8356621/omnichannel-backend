...
final class AgentWorkspaceV1SweepTest extends TestCase
{
    ...
    {
        $path = dirname(__DIR__, 4).'/docs/modules/AGENT_WORKSPACE.md';
...
final class AgentV1DoctorTest extends TestCase
{
    public function test_doctor_command_registered(): void
    {
        $cmd = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/agent/src/Console/AgentV1DoctorCommand.php',
        );
    ...
    {
        $cmd = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/agent/src/Console/AgentCapabilitiesAuditCommand.php',
        );
    ...
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/agent/src/Services/AgentWorkspace/V1/AgentV1ReadinessService.php',
        );
        self::assertStringNotContainsString('ContentProjectCommandBus', $source);
    ...
    public function test_ui_readiness_action_exists(): void
    {
        $page = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/agent/src/Filament/Pages/AgentWorkspacePage.php',
        );
