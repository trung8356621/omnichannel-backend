...
final class ProductReviewAutomationPublishTest extends TestCase
{
    ...
    public function test_store_service_creates_pending_only(): void
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/commerce/src/Services/ProductReview/ArticleProductReviewStoreService.php',
        );
    ...
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/agent/src/Automation/BusinessHook/Actions/PublishWordPressCommentReviewHookAction.php',
        );
