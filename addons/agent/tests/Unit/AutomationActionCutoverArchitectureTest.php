...
final class AutomationActionCutoverArchitectureTest extends TestCase
{
    ...
    {
        $path = dirname(__DIR__, 4).'/addons/content/src'.DIRECTORY_SEPARATOR.'Http'.DIRECTORY_SEPARATOR.'Controllers'
    ...
    {
        $path = dirname(__DIR__, 4).'/addons/content/src'.DIRECTORY_SEPARATOR.'Services'
    ...
    {
        $path = dirname(__DIR__, 4).'/addons/search-foundation/src'.DIRECTORY_SEPARATOR.'Observers'
    ...
    {
        $path = dirname(__DIR__, 4).'/addons/ai-prompt/src'.DIRECTORY_SEPARATOR.'Services'
    ...
    {
        $path = dirname(__DIR__, 4).'/addons/content/src'.DIRECTORY_SEPARATOR.'Filament'.DIRECTORY_SEPARATOR.'Resources'
