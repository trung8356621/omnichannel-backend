...
final class QueueRoutingContractTest extends TestCase
{
    ...
    public function test_wordpress_external_node_queue_name_is_automation_external(): void
    {
        ...
        $graph = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/agent/src/Automation/BusinessHook/Services/AutomationGraphExecutionService.php',
        );
    ...
    public function test_filament_queued_notifications_resolve_to_connection_default_not_wp_queues(): void
    {
        ...
        $notificationSources = [
            dirname(__DIR__, 4).'/addons/seo/src/Services/SeoNotificationService.php',
            dirname(__DIR__, 4).'/addons/content-projects/src/Support/CreateArticleWorkflowNotification.php',
            dirname(__DIR__, 4).'/addons/content/src/Services/TeamChatNotificationService.php',
        ];
