...
final class PromptHookRuntimePhase5BTest extends TestCase
{
    ...
    public function test_boundary_runtime_avoids_eloquent_filament_wordpress(): void
    {
        ...
        $dirs = [
            dirname(__DIR__, 4).'/addons/ai-prompt/src/PromptHooks/Runtime',
            dirname(__DIR__, 4).'/addons/ai-prompt/src/PromptHooks/Canonical',
            dirname(__DIR__, 4).'/addons/ai-prompt/src/PromptHooks/Provider',
            dirname(__DIR__, 4).'/addons/ai-prompt/src/PromptHooks/Output',
        ];
        foreach ($dirs as $dir) {
