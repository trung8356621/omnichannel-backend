...
final class ExtensionCutoverAiPipelineTest extends TestCase
{
    ...
    {
        $manifestPath = dirname(__DIR__, 4).'/addons/agent/src/Extension/Builtin/AiProviders/plugin.json';
    ...
    {
        $manifestPath = dirname(__DIR__, 4).'/addons/agent/src/Extension/Builtin/ContentPipelines/plugin.json';
        $this->assertFileExists($manifestPath);
    ...
    public function test_seo_provider_contract_and_local_seo_builtin_exist(): void
    {
        ...
        $manifestPath = dirname(__DIR__, 4).'/addons/agent/src/Extension/Builtin/LocalSeo/plugin.json';
        $this->assertFileExists($manifestPath);
