...
final class PromptExecutionOrchestrationTest extends TestCase
{
    ...
    {
        $service = (string) file_get_contents(dirname(__DIR__, 4).'/addons/content-projects/src/Services/ArticlePipelineRerunService.php');
        ...
        self::assertFileDoesNotExist(dirname(__DIR__, 4).'/addons/content/src/Jobs/RerunArticlePipelineJob.php');
    }
