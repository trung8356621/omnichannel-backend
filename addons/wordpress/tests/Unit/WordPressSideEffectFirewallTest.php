...
final class WordPressSideEffectFirewallTest extends TestCase
{
    ...
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/wordpress/src/Jobs/SyncArticleToWordPressFromQueueJob.php',
        );
    ...
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/publishing/src/Services/ScheduledArticlePublishRunner.php',
        );
