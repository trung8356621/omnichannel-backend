...
final class WordPressFieldConflictPolicyTest extends TestCase
{
    ...
    public function test_laravel_managed_media_policy_allows_meta_and_attachment_slug_contract(): void
    {
        $classifier = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/media/resources/js/utils/mediaSourceClassification.js',
        );
        $metaUpdate = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/wordpress/src/Services/WordPressAttachmentMetaUpdateService.php',
        );
    ...
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/wordpress/src/Services/WordPressLocalMediaSyncService.php',
        );
