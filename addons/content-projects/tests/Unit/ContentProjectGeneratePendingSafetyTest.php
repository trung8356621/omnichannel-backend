...
final class ContentProjectGeneratePendingSafetyTest extends TestCase
{
    ...
    public function test_ui_has_project_operations_not_run_history_hub(): void
    {
        $resource = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Filament/Resources/SeoProjectResource.php',
        );
    ...
    public function test_hydrate_service_preserves_reviewing_and_is_idempotent_shaped(): void
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/ContentProjectLegacyExecutionHydrateService.php',
        );
    ...
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Services/SeoProjectWorkflowRunService.php',
        );
