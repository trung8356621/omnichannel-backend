...
final class ContentProjectApplicationApiFoundationTest extends TestCase
{
    ...
    {
        $path = dirname(__DIR__, 4).'/addons/content-projects/src/Http/Controllers/Api/V1/ContentProjectApiController.php';
    ...
    {
        $path = dirname(__DIR__, 4).'/addons/wordpress/src/Extension/WordPressPublisher.php';
        $source = (string) file_get_contents($path);
    ...
    {
        $path = dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/Application/Handlers/ProcessScheduledProjectItemPublishHandler.php';
        $source = (string) file_get_contents($path);
