...
final class ContentProjectRoleWorkflowContractTest extends TestCase
{
    ...
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Support/ContentProject/ContentProjectItemStateResolver.php',
        );
    ...
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/ContentProjectDashboardStatsService.php',
        );
    ...
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/ContentProjectContentManagerHandoffService.php',
        );
