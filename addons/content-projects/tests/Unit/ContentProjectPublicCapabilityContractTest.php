...
final class ContentProjectPublicCapabilityContractTest extends TestCase
{
    ...
    public function test_bulk_rerun_service_file_does_not_exist(): void
    {
        self::assertFileDoesNotExist(
            dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProjectBulkRerunService.php',
        );
    }
    ...
    {
        self::assertFileDoesNotExist(
            dirname(__DIR__, 4).'/addons/content/src/Jobs/RerunArticlePipelineJob.php',
        );
    }
    ...
    {
        self::assertFileDoesNotExist(
            dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProjectStepRerunService.php',
        );
    }
    ...
    public function test_legacy_ui_booleans_keys_still_present_from_available_actions_pattern(): void
    {
        $ops = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/ContentProjectItemOperationsReadModel.php',
        );
