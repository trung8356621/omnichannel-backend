...
final class ExtensionArchitectureFreezeTest extends TestCase
{
    ...
    {
        $dir = dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/Application/Publishing';
    ...
    {
        $dir = dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/Application/Handlers';
        self::assertDirectoryExists($dir);
    ...
    {
        $roots = [
            dirname(__DIR__, 4).DIRECTORY_SEPARATOR.'docs',
