...
final class ContentProjectItemIdentityEntryPointsTest extends TestCase
{
    ...
    {
        $path = dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/Application/Handlers/AddContentProjectItemsHandler.php';
        $src = (string) file_get_contents($path);
    ...
    {
        $path = dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/ContentProjectStepSourceValidator.php';
        $src = (string) file_get_contents($path);
    ...
    {
        $path = dirname(__DIR__, 4).'/addons/ai-prompt/src/PromptHooks/Runtime/PromptHookExplicitBindingExecutor.php';
        $src = (string) file_get_contents($path);
