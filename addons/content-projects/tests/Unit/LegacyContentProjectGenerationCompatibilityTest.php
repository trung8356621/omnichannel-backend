...
final class LegacyContentProjectGenerationCompatibilityTest extends TestCase
{
    ...
    {
        $source = (string) file_get_contents(dirname(__DIR__, 4).'/addons/content-projects/src/Services/SeoProjectWorkflowRunService.php');
    ...
    {
        $source = (string) file_get_contents(dirname(__DIR__, 4).'/addons/ai-prompt/src/Services/TaskTestInputResolver.php');
    ...
    {
        $source = (string) file_get_contents(dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/LegacyContentProjectItemHydrator.php');
