...
final class ContentProjectActiveExecutionLifecycleTest extends TestCase
{
    ...
    public function test_resolver_sot_wired_into_rerun_eligibility(): void
    {
        ...
        $handler = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/Application/Handlers/RerunProjectItemStepHandler.php',
        );
        $retry = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Services/SeoProjectWorkflowStepRetryService.php',
        );
        $view = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Filament/Resources/SeoProjectResource/Pages/ViewSeoProjectRun.php',
        );
    ...
    public function test_finalizer_and_repair_command_exist(): void
    {
        ...
        $cmd = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Console/RepairContentProjectActiveExecutionsCommand.php',
        );
        ...
        $repair = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/ContentProjectActiveExecutionRepairService.php',
        );
