...
final class ContentProjectPublishingQueueBoundaryContractTest extends TestCase
{
    ...
    public function test_schedule_future_sets_execution_none(): void
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/ContentProjectPublishingQueueService.php',
        );
    ...
    public function test_handoff_commands_registered(): void
    {
        ...
        $handler = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/Application/Handlers/SendToPublishingQueueHandler.php',
        );
    ...
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/ContentProjectAutoScheduleService.php',
        );
    ...
    public function test_publishing_queue_page_redirects_to_hub(): void
    {
        $page = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Filament/Resources/SeoProjectResource/Pages/ContentProjectPublishingQueue.php',
        );
