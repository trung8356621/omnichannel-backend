...
final class ContentProjectUiSixFixesContractTest extends TestCase
{
    ...
    public function test_image_picker_uses_per_page_28_and_tab_reset(): void
    {
        $controller = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/media/src/Http/Controllers/ArticleMediaPickerController.php',
        );
        ...
        $workspace = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/media/src/Http/Controllers/WorkspaceMediaPickerController.php',
        );
        ...
        $edit = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/src/Filament/Resources/ArticleResource/Pages/EditArticle.php',
        );
        ...
        $picker = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/media/resources/js/editor/host/SharedMediaPicker.jsx',
        );
    ...
    public function test_wordpress_view_action_requires_published_permalink(): void
    {
        ...
        $publisher = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/wordpress/src/Extension/WordPressPublisher.php',
        );
        ...
        $readModel = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/ContentProjectPublishingQueueReadModel.php',
        );
    ...
    public function test_media_library_uses_per_page_50(): void
    {
        $service = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/media/src/Services/SeoMediaLibraryService.php',
        );
        self::assertStringContainsString('int $perPage = 50', $service);

        $page = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/media/src/Filament/Pages/MediaLibrary.php',
        );
    ...
    public function test_generation_blocked_skipped_by_classifier_and_rerun_guard(): void
    {
        ...
        $guard = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/Application/Support/ContentProjectRerunEligibilityGuard.php',
        );
        ...
        $actionGuard = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Support/ContentProject/ContentProjectItemActionGuard.php',
        );
        ...
        $registrar = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/Application/ContentProjectCommandBusRegistrar.php',
        );
        ...
        $view = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Filament/Resources/SeoProjectResource/Pages/ViewSeoProject.php',
        );
        ...
        $blockHandler = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/Application/Handlers/BlockProjectItemGenerationHandler.php',
        );
        ...
        $unblockHandler = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/Application/Handlers/UnblockProjectItemGenerationHandler.php',
        );
