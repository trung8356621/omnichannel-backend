...
final class PublishingSchedulePlanContractTest extends TestCase
{
    ...
    {
        $path = dirname(__DIR__, 4).'/addons/content-projects/src/Filament/Resources/SeoProjectResource/Concerns/InteractsWithContentProjectPublishingActions.php';
    ...
    {
        $path = dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/ContentProjectAutoScheduleService.php';
        $src = (string) file_get_contents($path);
    ...
    {
        $path = dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/ContentProjectPublishingQueueService.php';
        $src = (string) file_get_contents($path);
