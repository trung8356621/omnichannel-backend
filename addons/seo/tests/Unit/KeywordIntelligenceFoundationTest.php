...
final class KeywordIntelligenceFoundationTest extends TestCase
{
    ...
    {
        $path = dirname(__DIR__, 4).'/addons/search-intelligence/src/Services/KeywordIntelligence/KeywordToContentProjectConverter.php';
        if (! is_file($path)) {
    ...
    {
        $dir = dirname(__DIR__, 4).'/addons/search-intelligence/src/Services/KeywordIntelligence/Application/Handlers';
        if (! is_dir($dir)) {
    ...
    {
        $registrarPath = dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/Application/ContentProjectCommandBusRegistrar.php';
    ...
    {
        $registryPath = dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/Application/Capabilities/ContentProjectCapabilityRegistry.php';
