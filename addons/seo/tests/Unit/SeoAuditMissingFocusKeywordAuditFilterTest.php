...
final class SeoAuditMissingFocusKeywordAuditFilterTest extends TestCase
{
    ...
    public function test_scoring_selection_does_not_union_keyword_review_ids(): void
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/seo/src/Services/SeoAuditKeywordFlagService.php',
        );
    ...
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/seo/src/Services/SeoAuditScanService.php',
        );
    ...
    public function test_analyze_job_persists_violations_via_analyzer_not_audit_resync(): void
    {
        $jobSrc = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/src/Jobs/AnalyzeArticleSeoJob.php',
        );
    ...
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/src/Filament/Pages/ArticlesOptimal.php',
        );
