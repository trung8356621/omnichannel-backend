...
final class SeoProjectWorkflowStepRetryServiceTest extends TestCase
{
    ...
    public function test_queue_js_cancel_requires_cancelled_count_or_already_idle(): void
    {
        $js = file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/resources/js/project-run-queue.js'
        );
    ...
    {
        $source = file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Services/SeoProjectRunItemService.php'
        );
        self::assertNotFalse($source);
