...
final class ArticleEditorCommandLayerPhase4Test extends TestCase
{
    ...
    {
        return dirname(__DIR__, 4).'/addons/content/resources/js/utils/editorCommands';
    }
    ...
    {
        $base = dirname(__DIR__, 4).'/addons/content/resources/js';
    ...
    {
        $path = dirname(__DIR__, 4).'/docs/architecture/ARTICLE_EDITOR_COMMAND_LAYER.md';
        self::assertFileExists($path);
