...
final class WordpressPublishWhitespaceAndCompletionContractTest extends TestCase
{
    ...
    public function test_dispatch_success_outcome_is_not_published_constant(): void
    {
        ...
        $runner = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Services/ContentProject/ContentProjectPublishingQueueRunner.php',
        );
    ...
    public function test_confirm_delivery_accepts_queued_for_delivery(): void
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/wordpress/src/Services/WordPressArticleSyncService.php',
        );
    ...
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/agent/src/Automation/BusinessHook/Seed/AutomationDefaultRulesSeeder.php',
        );
    ...
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/agent/src/Automation/BusinessHook/Actions/SyncArticleToWordPressHookAction.php',
        );
        self::assertStringContainsString('confirmContentProjectPublishDelivery', $src);
    ...
    public function test_reconcile_service_classifies_explicitly(): void
    {
        ...
        $cmd = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/publishing/src/Console/ReconcilePublishingQueueTasksCommand.php',
        );
    ...
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/src/Services/ArticleEditorHtmlSanitizeService.php',
        );
    ...
    {
        $cmd = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/publishing/src/Console/PublishScheduledArticlesCommand.php',
        );
