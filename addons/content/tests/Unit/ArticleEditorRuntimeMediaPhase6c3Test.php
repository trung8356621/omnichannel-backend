...
final class ArticleEditorRuntimeMediaPhase6c3Test extends TestCase
{
    ...
    {
        return dirname(__DIR__, 4).'/addons/content/resources/js/'.$relative;
    }
    ...
    public function test_media_identity_uses_composite_asset_key_not_bare_numeric_id(): void
    {
        ...
        $service = dirname(__DIR__, 4).'/addons/content/src/Services/ArticleEditor/ArticleEditorMediaSnapshotService.php';
        ...
        $local = dirname(__DIR__, 4).'/addons/media/src/Services/ArticleMediaLocalService.php';
    ...
    {
        $fixSlug = dirname(__DIR__, 4).'/addons/media/src/Services/SeoMediaArticleSlugFixService.php';
    ...
    public function test_stale_snapshot_guard_and_no_three_pickers(): void
    {
        ...
        $jsRoot = dirname(__DIR__, 4).'/addons/content/resources/js';
