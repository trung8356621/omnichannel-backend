...
final class ProductGalleryParentChildScaffoldTest extends TestCase
{
    ...
    {
        $dir = dirname(__DIR__, 4).'/addons/ai-prompt'.DIRECTORY_SEPARATOR.'resources'.DIRECTORY_SEPARATOR.'prompt-hooks'.DIRECTORY_SEPARATOR.'v01';
        foreach ([
    ...
    {
        $path = dirname(__DIR__, 4).'/addons/ai-prompt'.DIRECTORY_SEPARATOR.'database'.DIRECTORY_SEPARATOR.'migrations'
