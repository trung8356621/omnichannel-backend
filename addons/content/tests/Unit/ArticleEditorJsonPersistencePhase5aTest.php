...
final class ArticleEditorJsonPersistencePhase5aTest extends TestCase
{
    ...
    public function test_migration_and_writer_and_client_contracts_exist(): void
    {
        ...
        $persist = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/src/Services/ArticleEditorPersistService.php',
        );
        ...
        $client = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/resources/js/utils/articleEditorDocument.js',
        );
        ...
        $api = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/resources/js/utils/articleEditorApi.js',
        );
        self::assertStringContainsString('editor_document', $api);

        $cmd = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/src/Console/ArticleEditorDocumentBackfillCommand.php',
        );
        self::assertStringContainsString('seo:article-editor-document-backfill', $cmd);
        self::assertStringContainsString('dry-run', $cmd);

        $doc = dirname(__DIR__, 4).'/docs/architecture/ARTICLE_EDITOR_JSON_PERSISTENCE.md';
    ...
    public function test_writer_has_canonical_and_legacy_apis(): void
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/src/Services/ArticleEditor/Document/ArticleEditorDocumentWriter.php',
        );
    ...
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/resources/js/utils/articleEditorStorage.js',
        );
