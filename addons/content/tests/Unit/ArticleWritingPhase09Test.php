...
final class ArticleWritingPhase09Test extends TestCase
{
    ...
    {
        $roots = [
            dirname(__DIR__, 4).'/addons/content-projects/src/Services/CreateArticlesFromTaskService.php',
            dirname(__DIR__, 4).'/addons/content/src/Services/ArticleWritingExecutionService.php',
            dirname(__DIR__, 4).'/addons/content/src/Services/ArticleWritingLegacyRewriteAdapter.php',
            dirname(__DIR__, 4).'/addons/content-projects/src/Services/SeoProjectWorkflowStepCatalogService.php',
            dirname(__DIR__, 4).'/addons/ai-prompt/src/Services/TaskWorkflowTestRunner.php',
        ];
    ...
    public function test_heuristic_only_in_migration_suggester_for_roles(): void
    {
        ...
        $resolver = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Services/ArticleGenerationInputResolver.php',
        );
        $existing = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/ai-prompt/src/Services/WorkflowExistingAiOutputService.php',
        );
