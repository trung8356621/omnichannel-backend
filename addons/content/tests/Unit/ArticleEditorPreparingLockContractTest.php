...
final class ArticleEditorPreparingLockContractTest extends TestCase
{
    ...
    {
        $path = dirname(__DIR__, 4).'/addons/content/src/Services/ArticleEditorReadinessService.php';
    ...
    {
        $path = dirname(__DIR__, 4).'/addons/media/src/Services/ArticleEditorMediaAiService.php';
        $source = (string) file_get_contents($path);
    ...
    {
        $pagePath = dirname(__DIR__, 4).'/addons/content/src/Filament/Resources/ArticleResource/Pages/EditArticle.php';
