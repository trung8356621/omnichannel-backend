...
final class ArticleWritingAssemblerTest extends TestCase
{
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 4).'/addons/seo/src/Filament/Pages/SeoSettingsWorkflows.php');
    ...
    {
        $catalog = file_get_contents(dirname(__DIR__, 4).'/addons/content-projects/src/Services/SeoProjectWorkflowStepCatalogService.php');
        $create = file_get_contents(dirname(__DIR__, 4).'/addons/content-projects/src/Services/CreateArticlesFromTaskService.php');
