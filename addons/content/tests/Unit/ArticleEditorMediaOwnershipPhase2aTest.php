...
final class ArticleEditorMediaOwnershipPhase2aTest extends TestCase
{
    ...
    public function test_featured_wp_sync_keeps_remote_attachment_identity(): void
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/media/src/Services/ArticleMediaLocalService.php',
        );
    ...
    public function test_frontend_no_localstorage_featured_gallery_sot(): void
    {
        $featured = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/media/resources/js/utils/articleFeaturedImageStorage.js',
        );
        ...
        $album = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/media/resources/js/utils/articleProductAlbumStorage.js',
        );
        ...
        $snap = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/resources/js/utils/articleEditorMediaSnapshot.js',
        );
    ...
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/media/resources/js/utils/articleImagesUtils.js',
        );
