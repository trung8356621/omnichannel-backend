...
final class ArticleEditorSessionAcquireContractTest extends TestCase
{
    public function test_seo_article_api_fetch_sets_json_content_type_for_body(): void
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/seo/resources/js/utils/seoArticleApi.js',
        );
    ...
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/src/Services/ArticleEditor/ArticleEditorSessionService.php',
        );
