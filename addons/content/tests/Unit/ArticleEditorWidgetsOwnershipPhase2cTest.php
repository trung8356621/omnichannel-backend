...
final class ArticleEditorWidgetsOwnershipPhase2cTest extends TestCase
{
    ...
    public function test_frontend_faq_snapshot_and_cta_ownership_wiring(): void
    {
        $faqClient = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/resources/js/utils/articleEditorFaqSnapshot.js',
        );
        ...
        $faqEditor = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/resources/js/components/ArticleFaqEditor.jsx',
        );
        ...
        $cta = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/resources/js/components/CtaContactInsertList.jsx',
        );
        ...
        $commands = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/resources/js/utils/editorCommands/insertionCommands.js',
        );
        ...
        $ctx = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/resources/js/utils/editorCommands/editorCommandContext.js',
        );
        self::assertStringContainsString('assertWritableCommandContext', $ctx);
        self::assertFileDoesNotExist(
            dirname(__DIR__, 4).'/addons/content/resources/js/utils/editorInsertionCommands.js',
        );
    ...
    {
        $path = dirname(__DIR__, 4).'/docs/architecture/ARTICLE_EDITOR_WIDGETS_OWNERSHIP.md';
