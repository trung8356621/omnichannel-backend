...
final class ArticleMetaAndSeoScoreContractTest extends TestCase
{
    ...
    public function test_persist_client_analysis_delegates_to_php_engine(): void
    {
        $source = file_get_contents(
            dirname(__DIR__, 4).'/addons/seo/src/Services/SeoAnalyzerService.php'
        );
    ...
    {
        $source = file_get_contents(
            dirname(__DIR__, 4).'/addons/content/src/Http/Controllers/ArticleEditorSyncController.php'
        );
        self::assertIsString($source);
    ...
    {
        $source = file_get_contents(
            dirname(__DIR__, 4).'/addons/agent/src/Automation/Actions/Article/UpdateArticleSeoMetaAction.php'
        );
    ...
    public function test_js_preview_api_and_live_saved_labels_exist(): void
    {
        ...
        $panel = file_get_contents(
            dirname(__DIR__, 4).'/addons/seo/resources/js/components/SeoScorePanel.jsx'
        );
