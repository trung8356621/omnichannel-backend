...
final class ArticleWritingPhase06Test extends TestCase
{
    ...
    {
        $base = dirname(__DIR__, 4).'/addons/ai-prompt'.'/Services/ArticleWriting';
    ...
    public function test_improve_isolated_from_publish_and_generate(): void
    {
        $improve = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/ai-prompt'.'/Services/ArticleImproveExecutionService.php',
        );
        $create = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/ai-prompt'.'/Services/CreateArticlesFromTaskService.php',
        );
        $catalog = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/ai-prompt'.'/Services/SeoProjectWorkflowStepCatalogService.php',
        );
    ...
    public function test_editor_full_rewrite_wired_to_ui_and_resolver(): void
    {
        $edit = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/ai-prompt'.'/Filament/Resources/ArticleResource/Pages/EditArticle.php',
        );
        $actions = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/ai-prompt'.'/resources/views/filament/resources/article-resource/pages/partials/article-editor-page-actions.blade.php',
        );
        $resolver = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/ai-prompt'.'/Services/TaskTestInputResolver.php',
        );
    ...
    public function test_legacy_adapter_is_thin(): void
    {
        $adapter = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/ai-prompt'.'/Services/ArticleWritingLegacyRewriteAdapter.php',
        );
    ...
    {
        $path = dirname(__DIR__, 4).'/addons/ai-prompt'.'/resources/prompt-hooks/v01/article.content.improve@0.1.0.json';
    ...
    public function test_history_exposes_owner_and_source_metadata(): void
    {
        $history = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/ai-prompt'.'/Services/ArticlePromptRunHistoryService.php',
        );
        $view = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/ai-prompt'.'/resources/views/filament/resources/article-resource/pages/view-article-prompts.blade.php',
        );
