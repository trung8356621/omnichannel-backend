...
final class ArticleWritingStablePhase10Test extends TestCase
{
    public function test_settings_ui_does_not_render_rewrite_field(): void
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/seo/src/Filament/Pages/SeoSettingsWorkflows.php',
        );
    ...
    public function test_hook_selector_excludes_rewrite_for_new_prompts(): void
    {
        ...
        $src = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/ai-prompt/src/PromptHooks/Runtime/PromptHookEditorCatalog.php',
        );
    ...
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/ai-prompt/src/PromptHooks/PromptHookFormSchema.php',
        );
    ...
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/ai-prompt/src/Filament/Resources/PromptResource.php',
        );
        self::assertStringContainsString('isLegacyCompatibilityHook', $src);
    ...
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/ai-prompt/src/PromptHooks/Runtime/PromptHookExplicitBindingExecutor.php',
        );
    ...
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/ai-prompt/src/Services/TaskWorkflowTestRunner.php',
        );
        self::assertStringContainsString('DEPRECATED COMPATIBILITY ONLY', $src);
    ...
    public function test_no_runtime_reader_rewrite_task_id(): void
    {
        ...
        $svcFile = dirname(__DIR__, 4).'/addons/content/src/Services/ArticleWritingStableHealthService.php';
    ...
    public function test_stable_health_file_gates_and_evaluate_fail_contract(): void
    {
        ...
        $src = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/src/Services/ArticleWritingStableHealthService.php',
        );
    ...
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/src/Console/WorkflowDoctorCommand.php',
        );
    ...
    public function test_builder_does_not_treat_rewrite_as_write_from_outline(): void
    {
        $jsx = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content-projects/resources/js/components/ArticleFlowBuilder.jsx',
        );
