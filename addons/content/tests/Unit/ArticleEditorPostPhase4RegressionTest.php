...
final class ArticleEditorPostPhase4RegressionTest extends TestCase
{
    ...
    {
        $path = dirname(__DIR__, 4).'/addons/content/resources/js/utils/articleEditorPayloadAdapters.js';
    ...
    public function test_faq_removed_from_assistant_and_links_ui(): void
    {
        $navigator = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/seo/resources/js/utils/seoAssistantNavigator.js',
        );
        $links = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/resources/js/components/ArticleLinksSidebar.jsx',
        );
        $modules = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/resources/js/utils/articleEditorModules.js',
        );
        $faqModule = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/resources/js/editor/modules/faq/index.js',
        );
        $editor = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/resources/js/components/SeoArticleEditor.jsx',
        );

        self::assertStringNotContainsString("id: 'faq'", $navigator);
        self::assertFileDoesNotExist(
            dirname(__DIR__, 4).'/addons/content/resources/js/components/ArticleEditorModuleHost.jsx',
        );
    ...
    public function test_existing_links_scanner_fixture_documents_git_regression_counts(): void
    {
        $scanner = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/resources/js/utils/existingLinkScanner.js',
        );
        $legacy = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/resources/js/utils/articleLinkScroll.js',
        );
    ...
    public function test_faq_and_links_runtime_modules_receive_article_id(): void
    {
        $faq = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/resources/js/editor/modules/faq/FaqSidebarPanel.jsx',
        );
        $links = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/resources/js/editor/modules/links/LinksSidebarPanel.jsx',
        );
    ...
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/resources/js/article-editor.jsx',
        );
    ...
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/seo/resources/js/components/ArticleGoogleSerpPreview.jsx',
        );
    ...
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/resources/js/components/ArticleReviewsTab.jsx',
        );
