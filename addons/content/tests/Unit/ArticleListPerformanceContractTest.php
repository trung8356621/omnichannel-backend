...
final class ArticleListPerformanceContractTest extends TestCase
{
    ...
    {
        $resource = dirname(__DIR__, 4).'/addons/content/src/Filament/Resources/ArticleResource.php';
    ...
    {
        $summary = dirname(__DIR__, 4).'/addons/content/src/Support/ArticleListSeoSummary.php';
        ...
        $images = dirname(__DIR__, 4).'/addons/media/src/Services/ArticlePostImagesService.php';
    ...
    {
        $source = (string) file_get_contents(dirname(__DIR__, 4).'/addons/content/src/Support/ArticleListSeoSummary.php');
    ...
    public function test_article_eager_loads_include_faqs_and_sync_flag_meta(): void
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/src/Filament/Resources/ArticleResource.php',
        );
    ...
    public function test_diagnostics_default_off_and_safe_logging(): void
    {
        ...
        $diag = (string) file_get_contents(dirname(__DIR__, 4).'/addons/content/src/Support/ArticleListDiagnostics.php');
    ...
    private function listArticlesSource(): string
    {
        return (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/src/Filament/Resources/ArticleResource/Pages/ListArticles.php',
        );
    }
}
