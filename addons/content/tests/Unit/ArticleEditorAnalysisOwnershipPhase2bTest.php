...
final class ArticleEditorAnalysisOwnershipPhase2bTest extends TestCase
{
    ...
    public function test_frontend_policy_and_analyzer_wiring(): void
    {
        $ownership = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/seo/resources/js/utils/articleAnalysisOwnership.js',
        );
        ...
        $compose = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/seo/resources/js/utils/composeArticleAnalysis.js',
        );
        ...
        $analyzer = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/seo/resources/js/utils/seoAnalyzer.js',
        );
        ...
        $metrics = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/seo/resources/js/utils/seoReasonMetrics.js',
        );
        ...
        $health = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/ai-prompt/resources/js/utils/assistantWidgetHealth.js',
        );
        ...
        $i18n = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/resources/js/utils/i18n.js',
        );
    ...
    {
        $path = dirname(__DIR__, 4).'/docs/architecture/ARTICLE_EDITOR_ANALYSIS_OWNERSHIP.md';
