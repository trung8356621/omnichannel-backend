...
final class ArticleEditorFeaturedIdentityContractTest extends TestCase
{
    ...
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/media/resources/js/editor/modules/featured/FeaturedSidebarPanel.jsx',
        );
    ...
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/content/src/Services/ArticleEditor/ArticleEditorMediaMutationService.php',
        );
        self::assertStringContainsString('attachment_id', $source);
    ...
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 4).'/addons/media/src/Http/Controllers/ArticleEditorMediaSnapshotController.php',
        );
