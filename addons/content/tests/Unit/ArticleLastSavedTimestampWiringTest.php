...
final class ArticleLastSavedTimestampWiringTest extends TestCase
{
    public function test_update_article_content_action_only_touches_manual_for_editor_origin(): void
    {
        $source = file_get_contents(
            dirname(__DIR__, 4).'/addons/agent/src/Automation/Actions/Article/UpdateArticleContentAction.php'
        );
    ...
    public function test_wordpress_sync_success_touches_synced_timestamp(): void
    {
        ...
        $domain = file_get_contents(
            dirname(__DIR__, 4).'/addons/wordpress/src/Services/SyncDomainContentService.php'
        );
        $pull = file_get_contents(
            dirname(__DIR__, 4).'/addons/wordpress/src/Services/WordPressArticleContentService.php'
        );
    ...
    {
        $source = file_get_contents(
            dirname(__DIR__, 4).'/addons/content/src/Services/ArticleLastSavedTimestampService.php'
        );
        self::assertNotFalse($source);
