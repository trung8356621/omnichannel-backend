...
## 2–3. Inventory / matrix

See `AgentCapabilityInventory` + `agent:capabilities:audit`. Docs: MATRIX / GAP / FREEZE.

## 4–6. Gaps

Fixed P0 wiring listed in GAP_REPORT. Remaining: GSC/SEO Audit/article helpers = business_missing or partial — not faked.
...
- Factory mapping for stop/resume (+ update name→attributes)
...
Migration: none (reuse Phase 1–7 tables).

## 19–20. Tests / commands
