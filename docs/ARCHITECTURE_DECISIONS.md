...
> Index: [SUPER_MAP_INDEX.md](SUPER_MAP_INDEX.md) · [ARCHITECTURE_FREEZE_V1.md](ARCHITECTURE_FREEZE_V1.md)
...
**Enforcement:** `ExtensionArchitectureFreezeTest`, [BUILTIN_WORDPRESS_EXTENSION.md](BUILTIN_WORDPRESS_EXTENSION.md).
