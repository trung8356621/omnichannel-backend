...
2. Application boundary: `AgentWorkspaceApplicationService` — no CommandBus.
3. Execution: Phase 2 orchestrator → AgentGateway → CommandBus → Handler.
4. Planning: propose-only; never execute.
5. Knowledge / Automation / Observability / Pack contracts as Phase 4–7.
...
9. Confirmation: never downgrade vs canonical; archive/destructive ≥ `confirm`.
...
16. Compatibility: additive v1.x OK; breaking → v2.
...
20. v1 limitations: see Final Handoff § Known limitations.
