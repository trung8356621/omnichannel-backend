...
- Runner: `AgentAutomationRunner` → Phase 2 / Phase 3 only
...
See also: `AGENT_AUTOMATION_SCHEDULES.md`, `AGENT_AUTOMATION_CONDITIONS.md`, `AGENT_AUTOMATION_APPROVALS.md`, `AGENT_AUTOMATION_NOTIFICATIONS.md`, `AGENT_AUTOMATION_SECURITY.md`, `AGENT_WORKSPACE_PHASE_5_HANDOFF.md`.
