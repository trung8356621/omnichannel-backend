...
use App\Addons\SeoContentAi\Services\SeoApiConnectionProviderCatalog;
use App\Addons\SeoContentAi\Services\SeoProviderRegistry as LegacySeoApiProviderRegistry;
use App\Addons\SeoContentAi\Services\SiteSync\Inbound\SiteSyncDeltaEventIngestor;
use App\Addons\SeoContentAi\Support\SourceAwareAfterCommit;
...
final class BackendRiskClosureContractTest extends TestCase
{
    ...
    public function test_seo_api_catalog_and_extension_registry_are_distinct(): void
    {
        ...
        self::assertNotSame(
            ...
            \App\Addons\SeoContentAi\Extension\Registry\SeoProviderRegistry::class,
        );
    }
