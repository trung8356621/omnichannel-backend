...
final class ArticleListPerformanceContractTest extends TestCase
{
    ...
    {
        $resource = dirname(__DIR__, 2).'/Filament/Resources/ArticleResource.php';
    ...
    {
        $summary = dirname(__DIR__, 2).'/Support/ArticleListSeoSummary.php';
        ...
        $images = dirname(__DIR__, 2).'/Services/ArticlePostImagesService.php';
    ...
    {
        $source = (string) file_get_contents(dirname(__DIR__, 2).'/Support/ArticleListSeoSummary.php');
    ...
    {
        $config = (string) file_get_contents(dirname(__DIR__, 2).'/config/article_list.php');
        self::assertStringContainsString("env('SEO_ARTICLE_LIST_DIAGNOSTICS', false)", $config);

        $diag = (string) file_get_contents(dirname(__DIR__, 2).'/Support/ArticleListDiagnostics.php');
    ...
    private function listArticlesSource(): string
    {
        return (string) file_get_contents(
            dirname(__DIR__, 2).'/Filament/Resources/ArticleResource/Pages/ListArticles.php',
        );
    }
}
