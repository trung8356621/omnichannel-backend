...
/**
 * Move block within section — pure reorder mirror + source contracts.
...
final class ArticleEditorMoveBlockWithinSectionTest extends TestCase
{
    ...
    public function test_ui_has_single_and_double_arrows_with_distinct_tooltips(): void
    {
        ...
        self::assertStringContainsString("editor_move_block_up_within_section: 'Di chuyển lên trong section'", $i18n);
        self::assertStringContainsString("editor_move_block_prev_section: 'Chuyển sang section phía trên'", $i18n);
    }
    ...
    /**
     * Mirror of articleEditorBlockReorder.js — keep in sync.
     *
