...
use App\Addons\SeoContentAi\Services\ContentProject\ContentProjectExistingArticleReconcileResult;
...
final class ContentProjectGenerationCapabilityReconcileTest extends TestCase
{
    ...
    public function test_select_existing_command_and_handler_wiring(): void
    {
        $cmdSrc = (string) file_get_contents(
            (string) (new ReflectionClass(\App\Addons\SeoContentAi\Services\ContentProject\Application\Commands\SelectExistingArticleForProjectItemCommand::class))->getFileName(),
        );
        $handlerSrc = (string) file_get_contents(
            (string) (new ReflectionClass(\App\Addons\SeoContentAi\Services\ContentProject\Application\Handlers\SelectExistingArticleForProjectItemHandler::class))->getFileName(),
        );
        $registrarSrc = (string) file_get_contents(
            (string) (new ReflectionClass(\App\Addons\SeoContentAi\Services\ContentProject\Application\ContentProjectCommandBusRegistrar::class))->getFileName(),
        );
        $pickerSrc = (string) file_get_contents(
            (string) (new ReflectionClass(\App\Addons\SeoContentAi\Services\ContentProject\ContentProjectExistingArticlePickerService::class))->getFileName(),
        );
    ...
    {
        $src = (string) file_get_contents(
            (string) (new ReflectionClass(\App\Addons\SeoContentAi\Services\TaskTestInputResolver::class))->getFileName(),
        );
    ...
    public function test_resume_handler_rechecks_capability(): void
    {
        $src = (string) file_get_contents(
            (string) (new ReflectionClass(
                \App\Addons\SeoContentAi\Services\ContentProject\Application\Handlers\ResumeProjectItemFromFailedStepHandler::class
            ))->getFileName(),
        );
    ...
    public function test_read_model_wires_capability_and_article_repair(): void
    {
        $src = (string) file_get_contents(
            (string) (new ReflectionClass(
                \App\Addons\SeoContentAi\Services\ContentProject\ContentProjectItemOperationsReadModel::class
            ))->getFileName(),
        );
