...
/**
 * Source/contract test (plain string parsing — no class autoload, no Livewire mount,
 * no DB; mirrors ArticleEditorMountNoRemoteWpTest's approach) — Phase 2:
...
final class ArticleEditorCoreBootstrapContractTest extends TestCase
{
    public function test_core_bootstrap_exposes_identity_content_and_endpoint_map(): void
    {
        ...
        foreach ([
            ...
            "'expectedContentHash'", "'featuredImageUrl'", "'endpoints'", "'settings'",
        ] as $needle) {
    ...
    /**
     * Extract one method body only (brace-depth matched) — avoids autoloading the
