...
/**
 * Phase 6A — contract tests for internal editor runtime (built-in modules only).
 */
final class ArticleEditorRuntimePhase6aTest extends TestCase
{
    ...
    public function test_seo_article_editor_uses_runtime_extensions(): void
    {
        ...
        self::assertStringContainsString('Phase 6A — sync internal runtime context', $source);
    ...
    {
        $doc = dirname(__DIR__, 5).'/docs/architecture/ARTICLE_EDITOR_RUNTIME.md';
