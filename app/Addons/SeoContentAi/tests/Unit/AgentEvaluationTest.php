...
use App\Addons\SeoContentAi\Services\AgentWorkspace\Observability\AgentCostUsageTracker;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Observability\AgentGovernancePolicyService;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Observability\AgentObservabilityCatalog;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Observability\AgentPolicyViolationDetector;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Observability\Evaluation\AgentAutomationHealthEvaluator;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Observability\Evaluation\AgentExecutionOutcomeEvaluator;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Observability\Evaluation\AgentGroundingEvaluator;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Observability\Evaluation\AgentPlanningEvaluator;
...
final class AgentTraceTest extends TestCase
{
    ...
    {
        $source = (string) file_get_contents(
            (new ReflectionClass(\App\Addons\SeoContentAi\Services\AgentWorkspace\Observability\AgentTraceService::class))->getFileName(),
        );
...
final class AgentMetricTest extends TestCase
{
    ...
    {
        $source = (string) file_get_contents(
            (new ReflectionClass(\App\Addons\SeoContentAi\Services\AgentWorkspace\Observability\AgentMetricAggregator::class))->getFileName(),
        );
    ...
    {
        $source = (string) file_get_contents(
            (new ReflectionClass(\App\Addons\SeoContentAi\Services\AgentWorkspace\Observability\AgentRetentionService::class))->getFileName(),
        );
...
final class AgentReviewTest extends TestCase
{
    ...
    {
        $source = (string) file_get_contents(
            (new ReflectionClass(\App\Addons\SeoContentAi\Services\AgentWorkspace\Observability\AgentFeedbackService::class))->getFileName(),
        );
    ...
    {
        $source = (string) file_get_contents(
            (new ReflectionClass(\App\Addons\SeoContentAi\Services\AgentWorkspace\Observability\AgentReviewService::class))->getFileName(),
        );
