...
final class BusinessHookSmokeTest extends TestCase
{
    ...
    {
        $this->assertTrue(is_a(SyncArticleToWordPressHookAction::class, \App\Addons\SeoContentAi\Automation\BusinessHook\Contracts\AutomationActionHandler::class, true));
