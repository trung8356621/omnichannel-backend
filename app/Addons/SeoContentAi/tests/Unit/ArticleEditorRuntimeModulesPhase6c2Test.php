...
final class ArticleEditorRuntimeModulesPhase6c2Test extends TestCase
{
    ...
    {
        $controller = dirname(__DIR__, 2).'/Http/Controllers/ArticleEditorFaqSnapshotController.php';
        ...
        $provider = dirname(__DIR__, 2).'/Providers/SeoPanelProvider.php';
    ...
    public function test_editor_hosted_modules_include_links_faq_cta(): void
    {
        ...
        // Phase 6C.4: AI cutover — no EXTERNAL_HOSTED modules; ai-chat is EDITOR_HOSTED.
