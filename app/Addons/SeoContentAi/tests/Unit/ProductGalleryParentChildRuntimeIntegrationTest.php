...
use App\Addons\SeoContentAi\Services\ProductGallery\ProductGalleryModeOrchestrator;
use App\Addons\SeoContentAi\Services\ProductGallery\ProductGalleryReferenceImageResolver;
use App\Addons\SeoContentAi\Support\ProductGallery\ImageProviderCapabilities;
...
use App\Addons\SeoContentAi\Support\ProductGallery\ProductGalleryReferenceImagePayload;
...
final class ProductGalleryParentChildRuntimeIntegrationTest extends TestCase
{
    ...
    {
        $media = new \App\Addons\SeoContentAi\Models\SeoMedia;
    ...
    public function test_adapter_and_job_classes_exist(): void
    {
        ...
        $this->assertTrue(class_exists(\App\Addons\SeoContentAi\Jobs\RunProductGalleryParentChildJob::class));
        $this->assertTrue(class_exists(\App\Addons\SeoContentAi\Services\ProductGallery\ProductGalleryParentChildDispatchService::class));
        $this->assertTrue(class_exists(\App\Addons\SeoContentAi\Console\ProductGalleryParentChildCanaryCommand::class));
    }
}
