...
/**
 * Phase 4 — Editor Command Layer source contracts.
 */
final class ArticleEditorCommandLayerPhase4Test extends TestCase
{
    private function root(): string
    {
        return dirname(__DIR__, 2).'/resources/js/utils/editorCommands';
    }
    ...
    {
        $path = dirname(__DIR__, 5).'/docs/architecture/ARTICLE_EDITOR_COMMAND_LAYER.md';
        self::assertFileExists($path);
