...
use App\Addons\SeoContentAi\Console\ArticleMetaAuditCommand;
use App\Addons\SeoContentAi\Console\ArticleMetaCleanupCommand;
...
use App\Addons\SeoContentAi\Support\ArticleMetaKeyCatalog;
...
final class ArticleMetaAndSeoScoreContractTest extends TestCase
{
    ...
    public function test_js_preview_api_and_live_saved_labels_exist(): void
    {
        ...
        $panel = file_get_contents(
            dirname(__DIR__, 2).'/resources/js/components/SeoScorePanel.jsx'
        );
