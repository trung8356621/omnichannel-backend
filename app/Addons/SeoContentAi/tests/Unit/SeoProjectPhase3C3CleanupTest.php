...
use App\Addons\SeoContentAi\Console\DiagnoseContentProjectCommand;
use App\Addons\SeoContentAi\Console\RepairContentProjectCommand;
...
use App\Addons\SeoContentAi\Services\SeoProjectRunItemMergeService;
use App\Addons\SeoContentAi\Services\SeoProjectRunItemService;
use App\Addons\SeoContentAi\Services\SeoProjectTaskRepairService;
...
use App\Addons\SeoContentAi\Support\SeoProjectTaskCanonicalResolver;
use ReflectionClass;
use Tests\TestCase;
...
final class SeoProjectPhase3C3CleanupTest extends TestCase
{
    ...
    {
        $path = base_path(
            'app/Addons/SeoContentAi/database/migrations/2026_07_19_201000_add_unique_project_source_key_to_seo_project_tasks_table.php',
        );
