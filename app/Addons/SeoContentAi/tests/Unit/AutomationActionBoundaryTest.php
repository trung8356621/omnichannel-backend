...
final class AutomationActionBoundaryTest extends TestCase
{
    ...
    {
        $base = dirname(__DIR__, 2).DIRECTORY_SEPARATOR.'Automation'.DIRECTORY_SEPARATOR.'Actions';
    ...
    public function test_group2_wired_callers_and_bridges_avoid_wordpress_outbound(): void
    {
        $paths = [
            ...
            dirname(__DIR__, 2).'/Services/PromptTestPublishService.php',
            dirname(__DIR__, 2).'/Automation/Migration/ProjectArticleCreateCallerBridge.php',
            dirname(__DIR__, 2).'/Automation/Migration/ProjectArticleContentCallerBridge.php',
            dirname(__DIR__, 2).'/Automation/Migration/ProjectArticleSeoMetaCallerBridge.php',
        ];
    ...
    public function test_registered_handlers_implement_business_action_and_unique_keys(): void
    {
        ...
        foreach (ActionHandlerRegistrar::handlers() as $class) {
            self::assertTrue(
                is_subclass_of($class, \App\Addons\SeoContentAi\Automation\Contracts\BusinessAction::class),
