...
use App\Addons\SeoContentAi\Services\PromptOwnership\PromptHookPresentationService;
use App\Addons\SeoContentAi\Services\SeoCreateArticleSettingsService;
use App\Addons\SeoContentAi\Support\CommentSeedingOutputParser;
...
final class PromptOwnershipModelTest extends TestCase
{
    ...
    public function test_inline_template_hooks_report_inline_content_mode(): void
    {
        ...
        foreach ([
            ...
            self::assertFalse(
                \App\Addons\SeoContentAi\PromptHooks\PromptHookFormSchema::usesLegacyPromptTemplate($hookKey, '0.1.0'),
                $hookKey,
            );
        }
    }
