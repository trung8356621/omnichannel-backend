...
final class ProductGalleryImageRoutingSettlementContractTest extends TestCase
{
    public function test_mode2_passes_concrete_model_not_null(): void
    {
        ...
        self::assertStringContainsString('Không có model ảnh hỗ trợ Parent/Child trong cấu hình hiện tại.', $src);
    }
    ...
    public function test_mode2_requires_execution_id_for_processing(): void
    {
        ...
        self::assertStringContainsString('Mode 2 Parent/Child không có gallery_execution_id để theo dõi.', $src);
    }
    ...
    public function test_adapter_uses_shared_routing_not_legacy_flash_fallback(): void
    {
        $source = (string) file_get_contents(
            (new ReflectionClass(\App\Addons\SeoContentAi\Services\ProductGallery\GeminiProductGalleryParentChildAiAdapter::class))->getFileName() ?: '',
        );
        ...
        self::assertStringContainsString('Không có model ảnh hỗ trợ Parent/Child trong cấu hình hiện tại.', $source);
    }
