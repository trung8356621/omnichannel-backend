...
/**
 * Post Phase 4 stabilization — static contracts for regression fixes.
...
final class ArticleEditorPostPhase4RegressionTest extends TestCase
{
    ...
    {
        $path = dirname(__DIR__, 2).'/resources/js/utils/articleEditorPayloadAdapters.js';
    ...
    public function test_faq_removed_from_assistant_and_links_ui(): void
    {
        $navigator = (string) file_get_contents(
            dirname(__DIR__, 2).'/resources/js/utils/seoAssistantNavigator.js',
        );
    ...
    public function test_existing_links_scanner_fixture_documents_git_regression_counts(): void
    {
        $scanner = (string) file_get_contents(
            dirname(__DIR__, 2).'/resources/js/utils/existingLinkScanner.js',
        );
    ...
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 2).'/resources/js/components/ArticleGoogleSerpPreview.jsx',
        );
