...
use App\Addons\SeoContentAi\Console\RepairUnprojectedPublishingCommand;
...
final class PublishingAwaitingDeliveryVisibilityContractTest extends TestCase
{
    ...
    {
        $blade = dirname(__DIR__, 2).'/resources/views/filament/pages/publishing-queue-hub.blade.php';
        ...
        $filter = dirname(__DIR__, 2).'/resources/views/components/content-project-filter-toolbar.blade.php';
