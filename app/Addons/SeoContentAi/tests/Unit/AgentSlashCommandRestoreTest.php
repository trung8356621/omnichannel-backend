...
use App\Addons\SeoContentAi\Filament\Resources\DomainResource\Pages\ViewDomainMcp;
...
use App\Addons\SeoContentAi\Services\AgentWorkspace\Execution\Presentation\ProjectDetailPresenter;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Execution\Presentation\ProjectListPresenter;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Execution\Rendering\ContentProjectResultRenderer;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Skills\ContentProjectSkills;
...
final class AgentSlashCommandRestoreTest extends TestCase
{
    ...
    public function test_execution_card_hides_envelope_for_user_facing(): void
    {
        $blade = (string) file_get_contents(
            dirname(__DIR__, 2).'/resources/views/filament/pages/partials/agent-execution-card.blade.php'
        );
    ...
    public function test_mcp_page_is_developer_global_reference(): void
    {
        ...
        $view = (string) file_get_contents(
            dirname(__DIR__, 2).'/resources/views/filament/resources/domain-resource/pages/view-domain-mcp.blade.php'
        );
        ...
        $generalView = (string) file_get_contents(
            dirname(__DIR__, 2).'/resources/views/filament/resources/domain-resource/pages/general-domain.blade.php'
        );
    ...
    {
        $result = (new \App\Addons\SeoContentAi\Services\AgentWorkspace\Execution\Dtos\AgentExecutionResult(
            executionRef: 'aex_1',
            status: \App\Addons\SeoContentAi\Enums\AgentWorkspace\AgentExecutionStatus::Succeeded,
            ok: true,
            code: 'ok',
