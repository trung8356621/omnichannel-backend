...
final class ContentProjectRoleWorkflowContractTest extends TestCase
{
    ...
    {
        // Schedule CTA left Content Project — Publishing Queue owns it.
    ...
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 2).'/Support/ContentProject/ContentProjectItemStateResolver.php',
        );
    ...
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 2).'/Services/ContentProject/ContentProjectDashboardStatsService.php',
        );
    ...
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 2).'/Services/ContentProject/ContentProjectContentManagerHandoffService.php',
        );
    ...
    public function test_lang_labels_reporting_semantics(): void
    {
        ...
        self::assertStringContainsString("'ops_needs_review' => 'Cần biên tập'", $vi);
        self::assertStringContainsString("'ops_in_review' => 'Đã biên tập'", $vi);
