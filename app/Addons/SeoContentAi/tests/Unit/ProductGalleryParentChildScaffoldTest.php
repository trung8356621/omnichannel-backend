...
use App\Addons\SeoContentAi\Services\ProductGallery\ProductGalleryGenerationModeResolver;
use App\Addons\SeoContentAi\Services\ProductGallery\ProductGalleryPlanParser;
use App\Addons\SeoContentAi\Services\ProductGallery\ProductGallerySelectionService;
use App\Addons\SeoContentAi\Services\ProductGallery\ProductGallerySerialChildLoop;
...
final class ProductGalleryParentChildScaffoldTest extends TestCase
{
    ...
    {
        $dir = dirname(__DIR__, 2).DIRECTORY_SEPARATOR.'resources'.DIRECTORY_SEPARATOR.'prompt-hooks'.DIRECTORY_SEPARATOR.'v01';
        foreach ([
    ...
    {
        $this->assertTrue(class_exists(\App\Addons\SeoContentAi\Services\ProductGallery\ProductGalleryParentChildCoordinator::class));
        $this->assertTrue(class_exists(\App\Addons\SeoContentAi\Services\ProductGallery\ProductGalleryReferenceChildValidator::class));
        $this->assertTrue(interface_exists(\App\Addons\SeoContentAi\Contracts\ProductGalleryParentChildAiPort::class));
    ...
    {
        $this->assertSame('generated_parent', \App\Addons\SeoContentAi\Support\ProductGallery\ProductGalleryArtifactRole::GENERATED_PARENT);
        $this->assertSame('generated_child_reference', \App\Addons\SeoContentAi\Support\ProductGallery\ProductGalleryArtifactRole::GENERATED_CHILD_REFERENCE);
    }
    ...
    public function test_mode1_classes_still_present(): void
    {
        ...
        $ref = new ReflectionClass(\App\Addons\SeoContentAi\Services\ProductGallery\ProductGalleryParentChildCoordinator::class);
