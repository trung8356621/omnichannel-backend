...
use App\Addons\SeoContentAi\Support\ContentProject\ArticleLastContentChange;
...
final class ArticleLastContentChangePhase21Test extends TestCase
{
    ...
    {
        $path = dirname(__DIR__, 2).'/database/migrations/2026_07_26_160000_add_last_ai_content_at_to_articles_table.php';
