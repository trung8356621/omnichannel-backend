...
final class SeoAuditScanServiceTest extends TestCase
{
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2).'/Filament/Pages/ArticlesOptimal.php') ?: '';
    ...
    {
        $source = file_get_contents(dirname(__DIR__, 2).'/resources/views/filament/pages/articles-optimal.blade.php') ?: '';
