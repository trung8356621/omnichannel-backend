...
use App\Addons\SeoContentAi\Automation\Runtime\CatalogBusinessActionDispatcher;
...
final class AutomationActionCutoverArchitectureTest extends TestCase
{
    ...
    {
        $path = dirname(__DIR__, 2).DIRECTORY_SEPARATOR.'Http'.DIRECTORY_SEPARATOR.'Controllers'
    ...
    {
        $path = dirname(__DIR__, 2).DIRECTORY_SEPARATOR.'Services'
    ...
    {
        $path = dirname(__DIR__, 2).DIRECTORY_SEPARATOR.'Observers'
    ...
    {
        $path = dirname(__DIR__, 2).DIRECTORY_SEPARATOR.'Filament'.DIRECTORY_SEPARATOR.'Resources'
