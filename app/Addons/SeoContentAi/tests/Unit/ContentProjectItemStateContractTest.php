...
use App\Addons\SeoContentAi\Enums\ContentProjectItemDashboardBucket;
use App\Addons\SeoContentAi\Enums\ContentProjectItemErrorSource;
use App\Addons\SeoContentAi\Enums\ContentProjectItemExecutionState;
...
use App\Addons\SeoContentAi\Support\ContentProject\ContentProjectItemDashboardBucketMapper;
...
use App\Addons\SeoContentAi\Support\ContentProject\ContentProjectStatusDecision;
...
final class ContentProjectItemStateContractTest extends TestCase
{
    ...
    public function test_production_task_status_writers_bounded(): void
    {
        ...
        foreach ($files as $rel) {
            $path = $root.'/'.$rel;
            if (! is_file($path)) {
                $path = $root.'/'.str_replace('Services/ContentProject/RunEngine/', 'Services/RunEngine/', $rel);
            }
