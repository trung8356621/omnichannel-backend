...
use App\Addons\SeoContentAi\Services\AgentWorkspace\Packs\AgentPackCapabilityBinder;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Packs\AgentPackCompatibilityService;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Packs\AgentPackCompiler;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Packs\AgentPackConstants;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Packs\AgentPackImportExportService;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Packs\AgentPackManifestValidator;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Packs\AgentPackOrchestrator;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Packs\AgentPackSafeMappingValidator;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Packs\AgentPackSafeSchemaValidator;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Observability\Evaluation\BuiltinAgentEvaluationDatasetInstaller;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Skills\BuiltinSkillCatalog;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Skills\PackSkills;
...
final class BuiltinAgentDatasetTest extends TestCase
{
    ...
    public function test_installer_command_registered_source(): void
    {
        $cmd = (string) file_get_contents(
            dirname(__DIR__, 2).'/Console/InstallBuiltinAgentEvaluationsCommand.php',
        );
...
final class AgentPackUiPermissionTest extends TestCase
{
    public function test_packs_panel_exists_and_manager_gated(): void
    {
        $page = (string) file_get_contents(
            dirname(__DIR__, 2).'/Filament/Pages/AgentWorkspacePage.php',
        );
        ...
        $blade = (string) file_get_contents(
            dirname(__DIR__, 2).'/resources/views/filament/pages/partials/agent-workspace/packs-panel.blade.php',
        );
