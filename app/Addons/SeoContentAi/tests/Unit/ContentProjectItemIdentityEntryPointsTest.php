...
final class ContentProjectItemIdentityEntryPointsTest extends TestCase
{
    ...
    {
        $path = dirname(__DIR__, 2).'/Services/ContentProject/Application/Handlers/AddContentProjectItemsHandler.php';
        $src = (string) file_get_contents($path);
    ...
    {
        $path = dirname(__DIR__, 2).'/Services/ContentProject/ContentProjectStepSourceValidator.php';
        $src = (string) file_get_contents($path);
    ...
    {
        $path = dirname(__DIR__, 2).'/PromptHooks/Runtime/PromptHookExplicitBindingExecutor.php';
        $src = (string) file_get_contents($path);
