...
use App\Addons\SeoContentAi\Console\ReconcileStuckPublishingCommand;
...
use App\Addons\SeoContentAi\Services\ContentProject\Application\Publishing\PublishFailureClassifier;
...
use App\Addons\SeoContentAi\Services\ContentProject\Application\Publishing\PublishingWordPressReconciler;
use App\Addons\SeoContentAi\Services\ContentProject\Publishing\PublishingRecoveryNotifier;
use App\Addons\SeoContentAi\Services\ContentProject\Publishing\PublishingStuckRecoveryService;
use App\Addons\SeoContentAi\Support\PublishingQueue\PublishingQueueRetryWaitDefinition;
...
use App\Addons\SeoContentAi\Services\WordPress\SideEffect\SystemWordPressContext;
use App\Addons\SeoContentAi\Services\WordPress\SideEffect\WordPressSideEffectGuard;
...
final class PublishingAutoRetryReconcileNotificationsContractTest extends TestCase
{
    ...
    public function test_operation_key_stable_format(): void
    {
        ...
        // mintNew requires SeoProjectTask — assert format via sprintf contract in source.
    ...
    public function test_retry_wait_not_publishing_badge(): void
    {
        ...
        self::assertStringContainsString('Lần 2/4', $classified['label']);
    }
    ...
    {
        $src = (string) file_get_contents(
            (string) (new ReflectionClass(\App\Addons\SeoContentAi\Services\ContentProject\Application\Support\ContentProjectIdempotencyStore::class))->getFileName(),
        );
    ...
    {
        $path = dirname(__DIR__, 2).'/database/migrations/2026_08_04_160000_add_publishing_lease_and_retry_fields_to_seo_project_tasks.php';
