...
final class AgentWorkspaceInteractionBindingTest extends TestCase
{
    ...
    {
        $path = dirname(__DIR__, 2).'/resources/views/components/agent-workspace/action-button.blade.php';
    ...
    {
        $addonViews = dirname(__DIR__, 2).'/resources/views';
        $roots = [
    ...
    {
        $pagePath = dirname(__DIR__, 2).'/Filament/Pages/AgentWorkspacePage.php';
    ...
    {
        $path = dirname(__DIR__, 2).'/resources/views/components/seo-agent-chat/composer.blade.php';
        $source = (string) file_get_contents($path);
