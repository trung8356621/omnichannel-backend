...
use App\Addons\SeoContentAi\Console\InstallDefaultProductGalleryPromptsCommand;
use App\Addons\SeoContentAi\Console\ProductGalleryPromptsDoctorCommand;
...
use App\Addons\SeoContentAi\Services\ProductGallery\ProductGalleryPromptsDoctorService;
...
final class ProductGalleryPromptDoctorTest extends TestCase
{
    ...
    public function test_doctor_checks_fallback_brief_disabled_flag(): void
    {
        ...
        $source = (string) file_get_contents(
            dirname(__DIR__, 2).'/Services/ProductGallery/ProductGalleryPromptsDoctorService.php',
        );
