...
use App\Addons\SeoContentAi\Services\AgentWorkspace\AgentWorkspaceVersion;
...
use App\Addons\SeoContentAi\Services\AgentWorkspace\V1\AgentCapabilityInventory;
use App\Addons\SeoContentAi\Services\AgentWorkspace\V1\AgentSkillGroupCatalog;
...
final class AgentV1DoctorTest extends TestCase
{
    public function test_doctor_command_registered(): void
    {
        $cmd = (string) file_get_contents(
            dirname(__DIR__, 2).'/Console/AgentV1DoctorCommand.php',
        );
    ...
    {
        $cmd = (string) file_get_contents(
            dirname(__DIR__, 2).'/Console/AgentCapabilitiesAuditCommand.php',
        );
    ...
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 2).'/Services/AgentWorkspace/V1/AgentV1ReadinessService.php',
        );
        self::assertStringNotContainsString('ContentProjectCommandBus', $source);
