...
use App\Addons\SeoContentAi\Filament\Resources\SeoProjectResource\Pages\CreateSeoProject;
...
final class ContentProjectArchivePreviewAndDomainContextTest extends TestCase
{
    ...
    {
        $viewPath = dirname(__DIR__, 2).'/resources/views/filament/resources/seo-project-resource/partials/archive-project-modal-summary.blade.php';
        $view = (string) file_get_contents($viewPath);
