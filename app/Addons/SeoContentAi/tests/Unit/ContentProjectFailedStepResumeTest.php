...
final class ContentProjectFailedStepResumeTest extends TestCase
{
    ...
    public function test_content_node_seed_prefers_context_artifact_over_empty_meta(): void
    {
        $src = (string) file_get_contents(
            (string) (new ReflectionClass(\App\Addons\SeoContentAi\Services\TaskWorkflowTestRunner::class))->getFileName(),
        );
        ...
        $createSrc = (string) file_get_contents(
            (string) (new ReflectionClass(\App\Addons\SeoContentAi\Services\CreateArticlesFromTaskService::class))->getFileName(),
        );
