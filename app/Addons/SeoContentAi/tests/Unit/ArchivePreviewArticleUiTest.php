...
final class ArchivePreviewArticleUiTest extends TestCase
{
    ...
    {
        $viewPath = dirname(__DIR__, 2).'/resources/views/filament/resources/seo-project-resource/pages/content-project-archive-preview.blade.php';
    ...
    {
        $viewPath = dirname(__DIR__, 2).'/resources/views/filament/resources/seo-project-resource/partials/archive-preview-item-slideover.blade.php';
        $view = (string) file_get_contents($viewPath);
