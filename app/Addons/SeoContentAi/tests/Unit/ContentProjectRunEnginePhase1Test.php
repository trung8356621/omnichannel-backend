...
use App\Addons\SeoContentAi\Enums\ContentProjectArticleSemanticStatus;
use App\Addons\SeoContentAi\Enums\ContentProjectRunSemanticStatus;
use App\Addons\SeoContentAi\Jobs\RunContentProjectArticleJob;
...
use App\Addons\SeoContentAi\Support\RunEngine\ContentProjectRunStatusMapper;
...
final class ContentProjectRunEnginePhase1Test extends TestCase
{
    ...
    {
        $ref = new ReflectionClass(\App\Addons\SeoContentAi\Services\RunEngine\ContentProjectRunEngine::class);
        foreach ([
    ...
    {
        $settings = \App\Addons\SeoContentAi\Support\ContentProjectRunSettings::fromUserInput([
    ...
    {
        $path = dirname(__DIR__, 2).'/'.$relativeFromAddonRoot;
