...
final class SeoMigrationReconcilerTest extends TestCase
{
    ...
    public function test_reconciles_create_migration_when_table_already_exists(): void
    {
        ...
        $migrationPath = base_path('app/Addons/SeoContentAi/database/migrations/2026_05_16_100000_create_prompts_table.php');
        $files = [
    ...
    public function test_skips_non_create_migrations(): void
    {
        ...
        $migrationPath = base_path('app/Addons/SeoContentAi/database/migrations/2026_06_01_110000_add_default_model_category_to_prompts_table.php');
        $files = [
