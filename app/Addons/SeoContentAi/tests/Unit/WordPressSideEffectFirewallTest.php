...
use App\Addons\SeoContentAi\Services\WordPress\SideEffect\WordPressSideEffectLedger;
...
final class WordPressSideEffectFirewallTest extends TestCase
{
    ...
    public function test_article_sync_service_requires_context_parameter(): void
    {
        $method = new \ReflectionMethod(
            \App\Addons\SeoContentAi\Services\WordPressArticleSyncService::class,
            'syncForArticle',
        );
    ...
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 2).'/Services/ScheduledArticlePublishRunner.php',
        );
    ...
    public function test_ledger_service_exists(): void
    {
        ...
        self::assertTrue(class_exists(\App\Addons\SeoContentAi\Models\WordPressSideEffectAttempt::class));
    }
}
