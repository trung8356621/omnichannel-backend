...
use App\Addons\SeoContentAi\Console\WorkflowDoctorCommand;
use App\Addons\SeoContentAi\Contracts\SeoCreateArticleSettingsReader;
use App\Addons\SeoContentAi\Enums\WorkflowCapability;
...
use App\Addons\SeoContentAi\Services\WorkflowRoles\WorkflowDoctorService;
...
final class WorkflowConfigurationPhase08Test extends TestCase
{
    ...
    public function test_run_snapshot_keeps_flow_hash_and_roles(): void
    {
        ...
        // Đổi flow → hash mới (run cũ giữ hash cũ).
        $task->flow_data = [
            'nodes' => [
                [
                    'id' => 'n_content',
