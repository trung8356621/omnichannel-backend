...
use App\Addons\SeoContentAi\Services\ArticleEditor\ArticleDocumentVersionService;
...
final class ArticleEditorSessionLockContractTest extends TestCase
{
    ...
    public function test_migrations_define_document_version_and_sessions_table(): void
    {
        ...
        $versionMigration = (string) file_get_contents($base.'/2026_08_02_140000_add_document_version_to_articles_table.php');
        $sessionMigration = (string) file_get_contents($base.'/2026_08_02_140100_create_article_editor_sessions_table.php');
    ...
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 2).'/Automation/Support/ArticleContentConflictGuard.php',
        );
    ...
    public function test_session_controller_routes_and_methods_exist(): void
    {
        ...
        $provider = (string) file_get_contents(dirname(__DIR__, 2).'/Providers/SeoPanelProvider.php');
    ...
    public function test_frontend_session_client_and_user_scoped_draft(): void
    {
        $client = (string) file_get_contents(
            dirname(__DIR__, 2).'/resources/js/utils/editorSessionClient.js',
        );
    ...
    {
        $config = include dirname(__DIR__, 2).'/config/article_editor.php';
