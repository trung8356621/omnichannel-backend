...
use App\Addons\SeoContentAi\Console\DiagnoseContentProjectArchiveCommand;
...
final class SeoProjectPhase3C1LifecycleTest extends TestCase
{
    ...
    {
        $source = file_get_contents(
            (new ReflectionClass(\App\Addons\SeoContentAi\Services\SeoProjectTaskSyncService::class))->getFileName() ?: '',
        );
        $this->assertIsString($source);
