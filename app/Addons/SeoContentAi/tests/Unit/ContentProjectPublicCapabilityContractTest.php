...
/**
 * Batch E — public capability exposure contract (agent vs MCP) + Option B
 * item-restore removal. Pure PHPUnit — no Laravel boot / ExtensionStateStore.
 */
final class ContentProjectPublicCapabilityContractTest extends TestCase
{
    ...
    {
        self::assertFileDoesNotExist(
            dirname(__DIR__, 2).'/Services/ContentProjectStepRerunService.php',
        );
    }
    ...
    public function test_legacy_ui_booleans_keys_still_present_from_available_actions_pattern(): void
    {
        $ops = (string) file_get_contents(
            dirname(__DIR__, 2).'/Services/ContentProject/ContentProjectItemOperationsReadModel.php',
        );
