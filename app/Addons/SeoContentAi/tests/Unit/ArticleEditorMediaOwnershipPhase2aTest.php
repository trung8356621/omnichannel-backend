...
use App\Addons\SeoContentAi\Http\Controllers\ArticleEditorMediaSnapshotController;
use App\Addons\SeoContentAi\Services\ArticleEditor\ArticleEditorMediaMutationService;
use App\Addons\SeoContentAi\Services\ArticleEditor\ArticleEditorMediaSnapshotService;
use App\Addons\SeoContentAi\Services\ArticleMediaLocalService;
use PHPUnit\Framework\TestCase;
use ReflectionClass;

/**
 * Phase 2A — Featured/Gallery media snapshot ownership contracts.
 */
final class ArticleEditorMediaOwnershipPhase2aTest extends TestCase
{
    ...
    public function test_frontend_no_localstorage_featured_gallery_sot(): void
    {
        $featured = (string) file_get_contents(
            dirname(__DIR__, 2).'/resources/js/utils/articleFeaturedImageStorage.js',
        );
        ...
        $album = (string) file_get_contents(
            dirname(__DIR__, 2).'/resources/js/utils/articleProductAlbumStorage.js',
        );
