...
use App\Addons\SeoContentAi\PromptHooks\PromptHookOutputNormalizer;
use App\Addons\SeoContentAi\PromptHooks\PromptHookRegistry;
use App\Addons\SeoContentAi\PromptHooks\PromptHookSettingsResolver;
use App\Addons\SeoContentAi\PromptHooks\Spec\PromptHookLocaleResolver;
use App\Addons\SeoContentAi\PromptHooks\Spec\PromptHookSettingsMerger;
use App\Addons\SeoContentAi\PromptHooks\Spec\PromptHookSpecTemplateRenderer;
...
final class PromptHookSpecPhase5ATest extends TestCase
{
    ...
    {
        return dirname(__DIR__, 5).DIRECTORY_SEPARATOR.'docs'
    ...
    public function test_required_input_invalid_type_covered_by_foundation_loader(): void
    {
        ...
        $this->expectException(\App\Addons\SeoContentAi\PromptHooks\Exceptions\PromptHookException::class);
        $loader->hydrate([
            'schema_version' => 1,
            'key' => 'x.y',
            'version' => 1,
    ...
    public function test_invalid_hook_key_pattern_on_hydrate(): void
    {
        ...
        } catch (\App\Addons\SeoContentAi\PromptHooks\Exceptions\PromptHookException) {
    ...
    public function test_hook_boundary_spec_and_normalizer_avoid_wordpress_filament(): void
    {
        ...
        $base = dirname(__DIR__, 2).DIRECTORY_SEPARATOR.'PromptHooks';
