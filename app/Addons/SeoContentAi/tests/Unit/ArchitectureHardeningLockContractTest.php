...
use App\Addons\SeoContentAi\Observers\KeywordLinkListSyncObserver;
...
/**
 * Architecture Lock hardening contracts — fail closed, no silent overwrite / duplicate queue.
 */
