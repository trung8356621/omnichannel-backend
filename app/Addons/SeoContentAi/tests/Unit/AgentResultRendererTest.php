...
use App\Addons\SeoContentAi\Enums\AgentWorkspace\AgentErrorCategory;
use App\Addons\SeoContentAi\Enums\AgentWorkspace\AgentExecutionStatus;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Execution\AgentExecutionContextUpdater;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Execution\AgentExecutionIdempotencyFactory;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Execution\AgentPlanOutputBinder;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Execution\Dtos\AgentExecutionResult;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Execution\Rendering\AgentErrorRenderer;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Execution\Rendering\AgentResultRendererRegistry;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Execution\Rendering\ContentProjectResultRenderer;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Execution\Rendering\GenericAgentResultRenderer;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Execution\Rendering\KeywordResultRenderer;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Execution\Rendering\SerpResultRenderer;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Execution\DefaultAgentExecutionOrchestrator;
...
final class AgentResultRendererTest extends TestCase
{
    ...
    {
        $dir = dirname(__DIR__, 2).'/Services/AgentWorkspace/Execution/Rendering';
    ...
    public function test_idempotency_factory_unique_per_call(): void
    {
        ...
        self::assertStringContainsString('…', $factory->mask($a));
    }
