...
use App\Addons\SeoContentAi\Extension\Builtin\AiProviders\AiProvidersExtensionProvider;
use App\Addons\SeoContentAi\Extension\Builtin\AiProviders\ClaudeAiTextProvider;
use App\Addons\SeoContentAi\Extension\Builtin\AiProviders\GeminiAiTextProvider;
use App\Addons\SeoContentAi\Extension\Builtin\ContentPipelines\ContentPipelinesExtensionProvider;
...
use App\Addons\SeoContentAi\Extension\Builtin\LocalSeo\LocalSeoExtensionProvider;
use App\Addons\SeoContentAi\Extension\Builtin\LocalSeo\LocalSeoProvider;
use App\Addons\SeoContentAi\Extension\Contracts\AiImageProviderInterface;
use App\Addons\SeoContentAi\Extension\Contracts\AiTextProviderInterface;
use App\Addons\SeoContentAi\Extension\Contracts\PipelineDefinitionInterface;
...
use App\Addons\SeoContentAi\Services\Ai\ClaudeMessagesClient;
...
final class ExtensionCutoverAiPipelineTest extends TestCase
{
    ...
    {
        $manifestPath = dirname(__DIR__, 2).'/Extension/Builtin/AiProviders/plugin.json';
    ...
    {
        $manifestPath = dirname(__DIR__, 2).'/Extension/Builtin/ContentPipelines/plugin.json';
        $this->assertFileExists($manifestPath);
    ...
    public function test_seo_provider_contract_and_local_seo_builtin_exist(): void
    {
        ...
        $manifestPath = dirname(__DIR__, 2).'/Extension/Builtin/LocalSeo/plugin.json';
        $this->assertFileExists($manifestPath);
