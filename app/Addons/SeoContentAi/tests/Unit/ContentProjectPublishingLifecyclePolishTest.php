...
use App\Addons\SeoContentAi\Filament\Widgets\ContentProjectQueueHealthWidget;
...
final class ContentProjectPublishingLifecyclePolishTest extends TestCase
{
    ...
    public function test_queue_health_widget_exists(): void
    {
        ...
        $listSource = (string) file_get_contents(
            (new ReflectionClass(\App\Addons\SeoContentAi\Filament\Resources\SeoProjectResource\Pages\ListSeoProjects::class))->getFileName(),
        );
