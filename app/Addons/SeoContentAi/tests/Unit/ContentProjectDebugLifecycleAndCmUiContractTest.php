...
final class ContentProjectDebugLifecycleAndCmUiContractTest extends TestCase
{
    ...
    {
        // tests/Unit → SeoContentAi → Addons → app → project root
        $path = dirname(__DIR__, 5).DIRECTORY_SEPARATOR.'config'.DIRECTORY_SEPARATOR.'seo-content-ai.php';
    ...
    {
        $src = (string) file_get_contents(
            dirname(__DIR__, 2).'/Services/ContentProject/ContentProjectDebugLifecycleOverrideService.php',
        );
