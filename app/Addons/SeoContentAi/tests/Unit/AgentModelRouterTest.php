...
use App\Addons\SeoContentAi\Services\AgentWorkspace\Planning\Services\RegistryAgentModelRouter;
...
final class AgentModelRouterTest extends TestCase
{
    ...
    public function test_router_source_has_no_vendor_hardcode_branches(): void
    {
        $source = (string) file_get_contents(
            dirname(__DIR__, 2).'/Services/AgentWorkspace/Planning/Services/RegistryAgentModelRouter.php',
        );
