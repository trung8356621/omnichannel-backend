...
use App\Addons\SeoContentAi\Services\AgentWorkspace\AgentWorkspaceUiContext;
...
final class AgentWorkspaceUiTest extends TestCase
{
    ...
    {
        $viewPath = dirname(__DIR__, 2).'/resources/views/filament/pages/agent-workspace.blade.php';
    ...
    public function test_agent_workspace_does_not_embed_mcp_markdown(): void
    {
        ...
        self::assertFileDoesNotExist(
            dirname(__DIR__, 2).'/resources/views/filament/pages/partials/agent-workspace/general-panel.blade.php',
        );
    }

    public function test_shared_chat_components_exist(): void
    {
        $base = dirname(__DIR__, 2).'/resources/views/components/seo-agent-chat';
    ...
    {
        $bladePath = dirname(__DIR__, 2).'/resources/views/components/global-ai-chat.blade.php';
    ...
    {
        $path = dirname(__DIR__, 2).'/resources/views/filament/pages/partials/agent-context-panel.blade.php';
    ...
    {
        $path = dirname(__DIR__, 2).'/resources/views/filament/pages/partials/agent-skill-form.blade.php';
        $source = (string) file_get_contents($path);
