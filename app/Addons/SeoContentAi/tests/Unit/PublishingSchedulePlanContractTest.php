...
use App\Addons\SeoContentAi\Services\ContentProject\PublishingSchedulePlan;
...
final class PublishingSchedulePlanContractTest extends TestCase
{
    ...
    public function test_in_day_slots_are_unique_and_interval_correct(): void
    {
        ...
        // 14:30 + 5 safety = 14:35 local → 07:35Z; then +10m
    ...
    {
        $path = dirname(__DIR__, 2).'/Filament/Resources/SeoProjectResource/Concerns/InteractsWithContentProjectPublishingActions.php';
        ...
        self::assertStringContainsString('Không success toast', $src);
    }

    public function test_schedule_plan_service_uses_schedule_plan_persist(): void
    {
        $path = dirname(__DIR__, 2).'/Services/ContentProject/ContentProjectAutoScheduleService.php';
        $src = (string) file_get_contents($path);
    ...
    {
        $path = dirname(__DIR__, 2).'/Services/ContentProject/ContentProjectPublishingQueueService.php';
        $src = (string) file_get_contents($path);
