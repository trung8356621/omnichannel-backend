...
use App\Addons\SeoContentAi\Support\ContentProject\ContentProjectApprovedDefinition;
...
use App\Addons\SeoContentAi\Support\ContentProject\ContentProjectPendingOpsDefinition;
...
/**
 * SSOT: Summary bucket definitions ≡ list filter predicates.
...
final class ContentProjectOpsSsotContractTest extends TestCase
{
    ...
    public function test_definition_classes_exist_for_each_card(): void
    {
        ...
        self::assertTrue(class_exists(\App\Addons\SeoContentAi\Support\ContentProject\ContentProjectDraftOpsDefinition::class));
    ...
    public function test_ops_ui_separates_generation_workflow_reporting(): void
    {
        ...
        $toolbar = (string) file_get_contents(
            dirname(__DIR__, 2).'/resources/views/components/content-project-filter-toolbar.blade.php',
        );
    ...
    public function test_failure_type_mapper_legacy_reason(): void
    {
        self::assertSame(
            'timeout',
            \App\Addons\SeoContentAi\Support\ContentProject\ContentProjectFailureTypeMapper::resolve([
