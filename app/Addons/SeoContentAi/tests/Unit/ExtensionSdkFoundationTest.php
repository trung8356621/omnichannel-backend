...
use App\Addons\SeoContentAi\Extension\ExtensionCompatibilityChecker;
use App\Addons\SeoContentAi\Extension\ExtensionDiscovery;
use App\Addons\SeoContentAi\Extension\ExtensionEventBus;
use App\Addons\SeoContentAi\Extension\ExtensionManifest;
...
use App\Addons\SeoContentAi\Extension\SdkVersion;
use App\Addons\SeoContentAi\Extension\Builtin\Wordpress\WordpressExtensionProvider;
...
final class ExtensionSdkFoundationTest extends TestCase
{
    ...
    {
        $pluginJson = dirname(__DIR__, 2).'/Extension/Builtin/Wordpress/plugin.json';
    ...
    public function test_publisher_registry_registers_fake_driver(): void
    {
        ...
        $driver = new class implements \App\Addons\SeoContentAi\Extension\Contracts\PublisherDriver
        {
