...
final class ContentProjectUiSixFixesContractTest extends TestCase
{
    ...
    public function test_image_picker_uses_per_page_28_and_tab_reset(): void
    {
        $controller = (string) file_get_contents(
            dirname(__DIR__, 2).'/Http/Controllers/ArticleMediaPickerController.php',
        );
        ...
        $workspace = (string) file_get_contents(
            dirname(__DIR__, 2).'/Http/Controllers/WorkspaceMediaPickerController.php',
        );
        ...
        $picker = (string) file_get_contents(
            dirname(__DIR__, 2).'/resources/js/editor/host/SharedMediaPicker.jsx',
        );
    ...
    public function test_article_edit_links_are_real_anchors_with_blank_target(): void
    {
        $meta = (string) file_get_contents(
            dirname(__DIR__, 2).'/resources/views/components/content-project-item-meta.blade.php',
        );
    ...
    public function test_wordpress_view_action_requires_published_permalink(): void
    {
        ...
        $publisher = (string) file_get_contents(
            dirname(__DIR__, 2).'/Extension/Builtin/Wordpress/WordPressPublisher.php',
        );
        ...
        $readModel = (string) file_get_contents(
            dirname(__DIR__, 2).'/Services/ContentProject/ContentProjectPublishingQueueReadModel.php',
        );
    ...
    public function test_media_library_uses_per_page_50(): void
    {
        $service = (string) file_get_contents(
            dirname(__DIR__, 2).'/Services/SeoMediaLibraryService.php',
        );
        self::assertStringContainsString('int $perPage = 50', $service);

        $page = (string) file_get_contents(
            dirname(__DIR__, 2).'/Filament/Pages/MediaLibrary.php',
        );
    ...
    public function test_generation_blocked_skipped_by_classifier_and_rerun_guard(): void
    {
        ...
        $migration = dirname(__DIR__, 2).'/database/migrations/2026_08_04_160000_add_generation_blocked_to_seo_project_tasks.php';
        ...
        self::assertStringContainsString('Item đã được đánh dấu bỏ qua tạo bài.', $guard);

        $actionGuard = (string) file_get_contents(
            dirname(__DIR__, 2).'/Support/ContentProject/ContentProjectItemActionGuard.php',
        );
        self::assertStringContainsString('Item đã được đánh dấu bỏ qua tạo bài.', $actionGuard);
        ...
        $blockHandler = (string) file_get_contents(
            dirname(__DIR__, 2).'/Services/ContentProject/Application/Handlers/BlockProjectItemGenerationHandler.php',
        );
        ...
        $unblockHandler = (string) file_get_contents(
            dirname(__DIR__, 2).'/Services/ContentProject/Application/Handlers/UnblockProjectItemGenerationHandler.php',
        );
