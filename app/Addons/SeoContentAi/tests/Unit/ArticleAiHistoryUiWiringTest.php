...
use App\Addons\SeoContentAi\Filament\Resources\ArticleResource\Pages\ViewArticlePrompts;
use App\Addons\SeoContentAi\Services\ArticleAiHistory\ArticleAiHistoryApplicationService;
use App\Addons\SeoContentAi\Services\ArticleAiHistory\ArticleAiHistoryLegacyClassifier;
...
final class ArticleAiHistoryUiWiringTest extends TestCase
{
    ...
    public function test_history_blade_has_typed_actions_and_no_page_nested_scroll_wrapper(): void
    {
        $blade = (string) file_get_contents(
            dirname(__DIR__, 2)
            .'/resources/views/filament/resources/article-resource/pages/view-article-prompts.blade.php',
        );
