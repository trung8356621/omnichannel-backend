...
final class ArticleEditorRuntimeNavigationPhase6c1Test extends TestCase
{
    ...
    public function test_host_mounts_navigation_without_tiptap_remount_coupling(): void
    {
        ...
        // TipTap extensions still from cached runtime — navigation must not recreate extensions array.
    ...
    {
        $runtimeDoc = dirname(__DIR__, 5).'/docs/architecture/ARTICLE_EDITOR_RUNTIME.md';
        $shellDoc = dirname(__DIR__, 5).'/docs/architecture/ARTICLE_EDITOR_SHELL_BOUNDARY.md';
