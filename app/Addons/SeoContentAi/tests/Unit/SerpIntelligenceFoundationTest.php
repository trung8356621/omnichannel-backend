...
use App\Addons\SeoContentAi\Enums\Serp\SerpContentGapType;
use App\Addons\SeoContentAi\Enums\Serp\SerpPageType;
use App\Addons\SeoContentAi\Enums\Serp\SerpResultType;
use App\Addons\SeoContentAi\Enums\Serp\SerpSnapshotStatus;
use App\Addons\SeoContentAi\Models\SeoSerpSnapshot;
...
final class SerpIntelligenceFoundationTest extends TestCase
{
    ...
    {
        $dir = dirname(__DIR__, 2).'/Services/SerpIntelligence/Application/Handlers';
