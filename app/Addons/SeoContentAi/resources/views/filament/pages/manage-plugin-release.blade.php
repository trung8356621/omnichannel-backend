<div>
    <x-filament-panels::page>
        ...
        <div class="seo-settings-root">
            @include('seo-content-ai::filament.pages.partials.seo-settings-sidebar', ['active' => 'wp-plugin-release'])

            <div class="seo-settings-main">
                <header class="seo-settings-header">
                    <h1>{{ __('seo-content-ai::filament.wp_plugin_release.title') }}</h1>
                    <p>{{ __('seo-content-ai::filament.wp_plugin_release.upload_section_description') }}</p>
                </header>
