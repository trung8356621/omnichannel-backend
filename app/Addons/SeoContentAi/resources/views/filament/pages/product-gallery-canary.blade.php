    ...
    <x-filament-panels::page>
        <div class="space-y-6 max-w-5xl">
            <header class="space-y-2">
                <h1 class="text-xl font-semibold">Product Gallery Canary</h1>
            ...
            <section class="rounded-xl border border-gray-200 p-4 dark:border-gray-700 space-y-3">
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <x-filament::button size="sm" color="gray" wire:click="refreshReadiness" wire:loading.attr="disabled">
                        Kiểm tra lại
                    </x-filament::button>
                    <x-filament::button size="sm" color="gray" wire:click="loadPromptPreview" wire:loading.attr="disabled">
                        Preview prompts
                    </x-filament::button>
                    <x-filament::button size="sm" color="danger" wire:click="discardGenerated"
                        ...
                        Xóa kết quả canary đã generate
                    </x-filament::button>
                    @if ($this->editorUrl())
            ...
            <section class="rounded-xl border border-gray-200 p-4 dark:border-gray-700 space-y-2 text-sm">
                <h2 class="font-medium">Execution history (append-only)</h2>
                @if ($executionHistory === [])
