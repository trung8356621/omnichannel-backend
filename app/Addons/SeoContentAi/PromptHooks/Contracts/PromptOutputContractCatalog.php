...
namespace App\Addons\SeoContentAi\PromptHooks\Contracts;
...
final class PromptOutputContractCatalog
{
    ...
    {
        return dirname(__DIR__, 2).DIRECTORY_SEPARATOR.'resources'.DIRECTORY_SEPARATOR.'prompt-hooks'.DIRECTORY_SEPARATOR.'contracts';
    }
