...
final class ArticleMetaKeyCatalog
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            'seo_scoring_details' => [
                'purpose' => 'Legacy bonus/details blob fallback',
                'class' => self::CLASS_LEGACY,
                'cleanup' => false,
                'canonical_replacement' => 'seo_rule_violations',
                'writers' => [],
            ...
            'seo_title' => [
                'purpose' => 'WP SEO title mirror (editor prefers articles.title)',
                'class' => self::CLASS_COMPATIBILITY,
                'cleanup' => false,
                'canonical_replacement' => 'articles.title',
                'writers' => ['SyncDomainContentService', 'WordPressArticleContentService'],
                'readers' => ['SeoAnalyzerService', 'SiteMcp'],
            ],

            // Content / sync
            'wp_post_content' => [
                'purpose' => 'Cached WP/HTML body mirror for scoring when articles.body empty',
                'class' => self::CLASS_CACHE,
                'cleanup' => false,
                'canonical_replacement' => 'articles.body',
                'writers' => ['WordPressArticleContentService', 'SyncDomainContentService'],
                'readers' => ['SeoAnalyzerService', 'ArticleEditorPersistService'],
            ],
            'wp_post_type' => [
                'purpose' => 'WP post type mirror / fallback for articles.type',
                'class' => self::CLASS_CANONICAL,
                'cleanup' => false,
                'canonical_replacement' => 'articles.type',
                'writers' => ['CreateArticlesFromTaskService', 'WordPressArticleSyncService'],
                'readers' => ['ArticlePostTypeResolver', 'ArticleResource'],
            ],
            'wp_entity' => [
