...
use App\Addons\SeoContentAi\Support\ExcelFormulaEscaper;
...
final class ContentProjectArchiveExportService
{
    ...
    private function resolveArticleData(SeoProjectArchiveItem $item): array
    {
        ...
        return array_filter([
            ...
            'sync_status' => $article->wp_sync_status ?? null,
            'wordpress_post_id' => $article->wp_post_id ?? null,
            'last_synced_at' => $this->formatDateTime($article->last_synced_at),
