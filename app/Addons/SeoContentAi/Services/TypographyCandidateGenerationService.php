...
use App\Addons\SeoContentAi\Support\ImageRoutingExecutionPolicy;
...
final class TypographyCandidateGenerationService
{
    ...
    public function generateCandidates(
        ...
        bool $productContext,
        int $inputLength,
        ?\App\Addons\SeoContentAi\Support\TypographyComplexity $typographyComplexity,
        TypographyTemporaryStorageService $temporaryStorage,
        ?\App\Addons\SeoContentAi\Support\RenderingPreference $preference = null,
    ): array {
