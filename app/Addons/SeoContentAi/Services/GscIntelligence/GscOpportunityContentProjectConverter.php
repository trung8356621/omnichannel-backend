...
use App\Addons\SeoContentAi\Models\SeoGscProperty;
    ...
    private function buildItemFromOpportunity(SeoGscProperty $property, SeoGscOpportunity $opportunity): array
    {
        ...
        $context = [
            ...
            'keyword_ref' => $queryMapping?->keyword_id !== null
                ? \App\Addons\SeoContentAi\Services\KeywordIntelligence\Application\KeywordIntelligencePublicRef::keyword((int) $queryMapping->keyword_id)
                : null,
