...
use App\Addons\SeoContentAi\Support\TypographyScoringConfig;
use App\Addons\SeoContentAi\Support\VisionValidationModelRouter;
    ...
    public function validateCandidate(
        ...
        foreach ($models as $candidateModel) {
            try {
                ...
                if (! \App\Addons\SeoContentAi\Support\GeminiModelVersionPolicy::isProviderUnavailableError($exception->getMessage())
