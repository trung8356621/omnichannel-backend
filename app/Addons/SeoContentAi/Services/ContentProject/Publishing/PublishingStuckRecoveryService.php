...
namespace App\Addons\SeoContentAi\Services\ContentProject\Publishing;
...
use App\Addons\SeoContentAi\Services\ContentProject\Application\Publishing\PublishReconcileResult;
...
final class PublishingStuckRecoveryService
{
    ...
    private function applyFailure(
        SeoProjectTask $task,
        \App\Addons\SeoContentAi\Services\ContentProject\Application\Publishing\PublishFailureClassification $classification,
        string $batchId,
    ): string {
