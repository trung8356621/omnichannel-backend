    ...
    public function recommend(array $context = [], int $limit = 8): array
    {
        ...
        foreach ($keys as $key) {
            ...
            if ($key === 'content_project.archive' && ! empty($context['has_running_operations'])) {
                $availability = \App\Addons\SeoContentAi\Services\AgentWorkspace\Dtos\AgentSkillAvailability::of(
                    \App\Addons\SeoContentAi\Services\AgentWorkspace\Dtos\AgentSkillAvailability::WRONG_CONTEXT,
