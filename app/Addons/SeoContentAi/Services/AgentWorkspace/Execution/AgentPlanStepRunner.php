...
use App\Addons\SeoContentAi\Models\AgentWorkspace\SeoAgentExecutionPlan;
...
final class AgentPlanStepRunner
{
    ...
    public function runCurrentStep(
        ...
        if ($result->executionRef !== '') {
            $execution = \App\Addons\SeoContentAi\Models\AgentWorkspace\SeoAgentExecution::query()
