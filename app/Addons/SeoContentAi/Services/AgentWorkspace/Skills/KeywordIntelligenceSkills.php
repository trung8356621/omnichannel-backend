...
final class KeywordIntelligenceSkills
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            [
                'key' => 'keyword.merge_clusters',
                'slash_command' => '/merge-clusters',
                'name' => 'Gộp cluster',
                'description' => 'Gộp các keyword cluster đã chọn.',
                'category' => 'keyword_intelligence',
                'capability' => 'keyword_intelligence.merge_clusters',
                'sort_order' => 44,
                'required_scopes' => ['content-project:write'],
                'confirmation_policy' => 'confirm',
            ],
            [
                'key' => 'keyword.split_cluster',
                'slash_command' => '/split-cluster',
                'name' => 'Tách cluster',
                'description' => 'Preview/tách một keyword cluster.',
                'category' => 'keyword_intelligence',
                'capability' => 'keyword_intelligence.split_cluster',
                'sort_order' => 45,
                'required_scopes' => ['content-project:write'],
                'confirmation_policy' => 'preview',
            ],
