...
use App\Addons\SeoContentAi\Services\AgentWorkspace\Execution\AgentExecutionOrchestrator;
...
use App\Addons\SeoContentAi\Services\AgentWorkspace\Planning\Contracts\AgentPlanningOrchestrator;
...
use App\Addons\SeoContentAi\Services\AgentWorkspace\Knowledge\Contracts\AgentKnowledgeOrchestrator;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Knowledge\Data\AgentKnowledgeQuery;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Knowledge\Services\AgentMemoryCandidateExtractor;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Automation\Contracts\AgentAutomationOrchestrator;
...
use App\Addons\SeoContentAi\Services\AgentWorkspace\Observability\AgentFeedbackService;
...
use App\Addons\SeoContentAi\Services\AgentWorkspace\Observability\AgentOperationsDashboardService;
use App\Addons\SeoContentAi\Services\AgentWorkspace\Observability\AgentReviewService;
...
final class AgentWorkspaceApplicationService
{
    ...
    public function __construct(
        ...
        private readonly ?\App\Addons\SeoContentAi\Services\AgentWorkspace\Packs\AgentPackOrchestrator $packs = null,
    ) {}
    ...
    {
        return (new \App\Addons\SeoContentAi\Services\AgentWorkspace\V1\AgentSkillGroupCatalog)
            ->present($this->skills);
    }
    ...
    public function v1Readiness(AgentWorkspaceContext $context, bool $fixSafe = false): array
    {
        ...
        return app(\App\Addons\SeoContentAi\Services\AgentWorkspace\V1\AgentV1ReadinessService::class)
    ...
    {
        return \App\Addons\SeoContentAi\Services\AgentWorkspace\AgentWorkspaceVersion::snapshot();
    }
