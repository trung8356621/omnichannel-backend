...
use App\Addons\SeoContentAi\Services\SiteSync\Orchestration\SiteSyncLockService;
use App\Models\Site;
...
final class SiteSyncReconciliationService
{
    ...
    private function detectDrift(Site $site, array $entries, string $mode): array
    {
        ...
        $localCount = SeoArticle::query()->where('site_id', (int) $site->id)->whereNotNull('wp_post_id')->count();
        $missingRemote = 0;
