...
namespace App\Addons\SeoContentAi\Services\SiteSync\Cutover;

use App\Addons\SeoContentAi\Models\SiteSync\SeoSiteSyncProviderTimeline;
...
final class SiteSyncProviderTimelineService
{
    ...
    {
        if (! \App\Addons\SeoContentAi\Services\SiteSync\Support\SiteSyncInfrastructure::hasTable('seo_site_sync_provider_timelines')) {
            return;
        }
