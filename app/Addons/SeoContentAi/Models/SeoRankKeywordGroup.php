...
final class SeoRankKeywordGroup extends Model
{
    ...
    {
        if (! \App\Addons\SeoContentAi\Support\SeoAccessControl::shouldScopeToAccountOwner()) {
            return $query;
        }

        return $query->where('created_by', \App\Addons\SeoContentAi\Support\SeoAccessControl::accountSiteOwnerId());
    }
