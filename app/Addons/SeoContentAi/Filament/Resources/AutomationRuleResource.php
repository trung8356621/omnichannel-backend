                        ...
                        Forms\Components\Repeater::make('graph_nodes')
                            ->schema([
                                ...
                                Forms\Components\Select::make('node_type')
                                    ->options(collect(\App\Addons\SeoContentAi\Automation\BusinessHook\Enums\AutomationNodeType::cases())
                        ...
                        Forms\Components\Repeater::make('graph_edges')
                            ->schema([
                                ...
                                Forms\Components\Select::make('branch')
                                    ->options(collect(\App\Addons\SeoContentAi\Automation\BusinessHook\Enums\AutomationEdgeBranch::cases())
    ...
    public static function createRuleFromFormData(array $data): AutomationRule
    {
        try {
            ...
            if ($rule->isGraphMode()) {
                ...
                app(\App\Addons\SeoContentAi\Automation\BusinessHook\Services\AutomationGraphRuleService::class)
