...
final class AutomationWorkflowBuilder extends SeoPanelPage
{
        ...
        try {
            ...
            if ($expectedRevision !== null && (int) $rule->draft_revision !== $expectedRevision) {
                throw new AutomationException(
                    \App\Addons\SeoContentAi\Automation\BusinessHook\Enums\BusinessHookErrorCode::DraftConflict->value,
    ...
    public function testDryRun(array $payload): void
    {
        ...
        try {
            ...
            if (! $validation['valid']) {
                throw new AutomationException(
                    \App\Addons\SeoContentAi\Automation\BusinessHook\Enums\BusinessHookErrorCode::GraphValidationFailed->value,
