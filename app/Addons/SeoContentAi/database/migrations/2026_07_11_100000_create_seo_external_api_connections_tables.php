...
return new class extends Migration
{
    ...
    {
        Schema::connection($this->connection)->create('seo_gsc_master_connections', function (Blueprint $table): void {
            $table->id();
        ...
        Schema::connection($this->connection)->create('seo_gsc_property_mappings', function (Blueprint $table): void {
            $table->id();
        ...
        Schema::connection($this->connection)->create('seo_dataforseo_connections', function (Blueprint $table): void {
            $table->id();
            $table->unsignedBigInteger('user_id')->nullable()->index();
            $table->string('login');
            $table->text('password');
